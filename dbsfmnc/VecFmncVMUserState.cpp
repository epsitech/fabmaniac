/**
  * \file VecFmncVMUserState.cpp
  * vector VecFmncVMUserState (implementation)
...
string VecFmncVMUserState::getSref(
			const uint ix
		) {
...
string VecFmncVMUserState::getTitle(
			const uint ix
...
void VecFmncVMUserState::fillFeed(
			const uint ixFmncVLocale
			, Feed& feed
		) {
	feed.clear();
