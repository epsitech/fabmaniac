/**
  * \file PnlFmncSepHeadbar.h
  * API code for job PnlFmncSepHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSEPHEADBAR_H
#define PNLFMNCSEPHEADBAR_H
...
/**
  * PnlFmncSepHeadbar
  */
namespace PnlFmncSepHeadbar {
	/**
	  * StgInf (full: StgInfFmncSepHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngFmncSepHeadbarData)
		*/
