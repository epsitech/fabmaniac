/**
  ...
  * API code for job QryFmncTolMNTooltype (implementation)
...
/******************************************************************************
 class QryFmncTolMNTooltype::StatApp
 ******************************************************************************/

QryFmncTolMNTooltype::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncTolMNTooltype::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncTolMNTooltype");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncTolMNTooltype";
...
set<uint> QryFmncTolMNTooltype::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolMNTooltype::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTolMNTooltype::StatShr
 ******************************************************************************/

QryFmncTolMNTooltype::StatShr::StatShr(
			const uint ntot
...
bool QryFmncTolMNTooltype::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncTolMNTooltype");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncTolMNTooltype";
...
set<uint> QryFmncTolMNTooltype::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolMNTooltype::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTolMNTooltype::StgIac
 ******************************************************************************/

QryFmncTolMNTooltype::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncTolMNTooltype::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncTolMNTooltype");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncTolMNTooltype";
...
void QryFmncTolMNTooltype::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncTolMNTooltype";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncTolMNTooltype";
...
set<uint> QryFmncTolMNTooltype::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolMNTooltype::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
