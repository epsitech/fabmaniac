/**
  ...
  * API code for job QryFmncTtyRlv1NStep (implementation)
...
/******************************************************************************
 class QryFmncTtyRlv1NStep::StatApp
 ******************************************************************************/

QryFmncTtyRlv1NStep::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncTtyRlv1NStep::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncTtyRlv1NStep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncTtyRlv1NStep";
...
set<uint> QryFmncTtyRlv1NStep::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTtyRlv1NStep::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTtyRlv1NStep::StatShr
 ******************************************************************************/

QryFmncTtyRlv1NStep::StatShr::StatShr(
			const uint ntot
...
bool QryFmncTtyRlv1NStep::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncTtyRlv1NStep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncTtyRlv1NStep";
...
set<uint> QryFmncTtyRlv1NStep::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTtyRlv1NStep::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTtyRlv1NStep::StgIac
 ******************************************************************************/

QryFmncTtyRlv1NStep::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncTtyRlv1NStep::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncTtyRlv1NStep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncTtyRlv1NStep";
...
void QryFmncTtyRlv1NStep::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncTtyRlv1NStep";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncTtyRlv1NStep";
...
set<uint> QryFmncTtyRlv1NStep::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTtyRlv1NStep::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
