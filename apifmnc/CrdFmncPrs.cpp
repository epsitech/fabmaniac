/**
  * \file CrdFmncPrs.cpp
  * API code for job CrdFmncPrs (implementation)
...
/******************************************************************************
 class CrdFmncPrs::VecVDo
 ******************************************************************************/

uint CrdFmncPrs::VecVDo::getIx(
			const string& sref
		) {
...
string CrdFmncPrs::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncPrs::VecVSge
 ******************************************************************************/

uint CrdFmncPrs::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdFmncPrs::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncPrs::ContInf
 ******************************************************************************/

CrdFmncPrs::ContInf::ContInf(
			const uint numFSge
...
bool CrdFmncPrs::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncPrs";
...
set<uint> CrdFmncPrs::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncPrs::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncPrs::StatApp
 ******************************************************************************/

CrdFmncPrs::StatApp::StatApp(
...
bool CrdFmncPrs::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncPrs";
...
set<uint> CrdFmncPrs::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncPrs::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncPrs::StatShr
 ******************************************************************************/

CrdFmncPrs::StatShr::StatShr(
...
bool CrdFmncPrs::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncPrs";
...
set<uint> CrdFmncPrs::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncPrs::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdFmncPrs::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncPrs";
...
/******************************************************************************
 class CrdFmncPrs::DpchAppDo
 ******************************************************************************/

CrdFmncPrs::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCPRSDO, scrJref) {
...
string CrdFmncPrs::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncPrs::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncPrsDo");
...
/******************************************************************************
 class CrdFmncPrs::DpchEngData
 ******************************************************************************/

CrdFmncPrs::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCPRSDATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdFmncPrs::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncPrs::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncPrsData");
	else
		basefound = checkXPath(docctx, basexpath);
