/**
  ...
  * API code for job PnlFmncOrgADetail (declarations)
...
namespace PnlFmncOrgADetail {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncOrgADetail::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncOrgADetail::StatApp statappqry;
