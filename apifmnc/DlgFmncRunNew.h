/**
  ...
  * API code for job DlgFmncRunNew (declarations)
...
namespace DlgFmncRunNew {
	...
	public:
		...
		static const uint DETCPTPRJ = 2;
		static const uint DETCPTTIT = 3;
		static const uint BUTCNC = 4;
		static const uint BUTCRE = 5;

	public:
		Tag(const string& Cpt = "", const string& DetCptPrj = "", const string& DetCptTit = "", const string& ButCnc = "", const string& ButCre = "");
