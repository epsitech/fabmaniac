/**
  ...
  * API code for job PnlFmncFab1NFabuser (declarations)
...
namespace PnlFmncFab1NFabuser {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncFab1NFabuser::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFab1NFabuser::StatApp statappqry;
