/**
  ...
  * API code for job PnlFmncSmpAPar (declarations)
...
namespace PnlFmncSmpAPar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncSmpAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSmpAPar::StatApp statappqry;
