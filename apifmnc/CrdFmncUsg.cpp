/**
  * \file CrdFmncUsg.cpp
  * API code for job CrdFmncUsg (implementation)
...
/******************************************************************************
 class CrdFmncUsg::VecVDo
 ******************************************************************************/

uint CrdFmncUsg::VecVDo::getIx(
			const string& sref
		) {
...
string CrdFmncUsg::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncUsg::VecVSge
 ******************************************************************************/

uint CrdFmncUsg::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdFmncUsg::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncUsg::ContInf
 ******************************************************************************/

CrdFmncUsg::ContInf::ContInf(
			const uint numFSge
...
bool CrdFmncUsg::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncUsg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncUsg";
...
set<uint> CrdFmncUsg::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncUsg::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncUsg::StatApp
 ******************************************************************************/

CrdFmncUsg::StatApp::StatApp(
...
bool CrdFmncUsg::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncUsg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncUsg";
...
set<uint> CrdFmncUsg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncUsg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncUsg::StatShr
 ******************************************************************************/

CrdFmncUsg::StatShr::StatShr(
...
bool CrdFmncUsg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncUsg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncUsg";
...
set<uint> CrdFmncUsg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncUsg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdFmncUsg::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncUsg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncUsg";
...
/******************************************************************************
 class CrdFmncUsg::DpchAppDo
 ******************************************************************************/

CrdFmncUsg::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCUSGDO, scrJref) {
...
string CrdFmncUsg::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncUsg::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncUsgDo");
...
/******************************************************************************
 class CrdFmncUsg::DpchEngData
 ******************************************************************************/

CrdFmncUsg::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCUSGDATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdFmncUsg::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncUsg::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncUsgData");
	else
		basefound = checkXPath(docctx, basexpath);
