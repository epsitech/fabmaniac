/**
  ...
  * API code for job QryFmncRunMNPerson (implementation)
...
/******************************************************************************
 class QryFmncRunMNPerson::StatApp
 ******************************************************************************/

QryFmncRunMNPerson::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncRunMNPerson::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncRunMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncRunMNPerson";
...
set<uint> QryFmncRunMNPerson::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncRunMNPerson::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncRunMNPerson::StatShr
 ******************************************************************************/

QryFmncRunMNPerson::StatShr::StatShr(
			const uint ntot
...
bool QryFmncRunMNPerson::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncRunMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncRunMNPerson";
...
set<uint> QryFmncRunMNPerson::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncRunMNPerson::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncRunMNPerson::StgIac
 ******************************************************************************/

QryFmncRunMNPerson::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncRunMNPerson::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncRunMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncRunMNPerson";
...
void QryFmncRunMNPerson::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncRunMNPerson";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncRunMNPerson";
...
set<uint> QryFmncRunMNPerson::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncRunMNPerson::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
