/**
  ...
  * API code for job PnlFmncTtyKSteppar (declarations)
...
namespace PnlFmncTtyKSteppar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncTtyKSteppar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTtyKSteppar::StatApp statappqry;
