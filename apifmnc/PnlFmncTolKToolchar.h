/**
  ...
  * API code for job PnlFmncTolKToolchar (declarations)
...
namespace PnlFmncTolKToolchar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncTolKToolchar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTolKToolchar::StatApp statappqry;
