/**
  * \file CrdFmncPrs.h
  * API code for job CrdFmncPrs (declarations)
...
/**
  * CrdFmncPrs
  */
namespace CrdFmncPrs {
	/**
		* VecVDo (full: VecVFmncPrsDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppFmncPrsDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncPrsData)
		*/
