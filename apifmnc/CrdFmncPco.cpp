/**
  * \file CrdFmncPco.cpp
  * API code for job CrdFmncPco (implementation)
...
/******************************************************************************
 class CrdFmncPco::VecVDo
 ******************************************************************************/

uint CrdFmncPco::VecVDo::getIx(
			const string& sref
		) {
...
string CrdFmncPco::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncPco::VecVSge
 ******************************************************************************/

uint CrdFmncPco::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdFmncPco::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncPco::ContInf
 ******************************************************************************/

CrdFmncPco::ContInf::ContInf(
			const uint numFSge
			, const string& MrlAppHlp
			, const string& MtxCrdPco
		) : Block() {
	this->numFSge = numFSge;
	this->MrlAppHlp = MrlAppHlp;
	this->MtxCrdPco = MtxCrdPco;

	mask = {NUMFSGE, MRLAPPHLP, MTXCRDPCO};
};

bool CrdFmncPco::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncPco");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncPco";

	if (basefound) {
		if (extractUintAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "numFSge", numFSge)) add(NUMFSGE);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MrlAppHlp", MrlAppHlp)) add(MRLAPPHLP);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MtxCrdPco", MtxCrdPco)) add(MTXCRDPCO);
	};

	return basefound;
};

set<uint> CrdFmncPco::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdPco.compare(comp->MtxCrdPco) == 0) insert(items, MTXCRDPCO);

	return(items);
};

set<uint> CrdFmncPco::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {NUMFSGE, MRLAPPHLP, MTXCRDPCO};
...
/******************************************************************************
 class CrdFmncPco::StatApp
 ******************************************************************************/

CrdFmncPco::StatApp::StatApp(
...
bool CrdFmncPco::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncPco");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncPco";
...
set<uint> CrdFmncPco::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncPco::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncPco::StatShr
 ******************************************************************************/

CrdFmncPco::StatShr::StatShr(
...
bool CrdFmncPco::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncPco");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncPco";
...
set<uint> CrdFmncPco::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncPco::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdFmncPco::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncPco");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncPco";
...
/******************************************************************************
 class CrdFmncPco::DpchAppDo
 ******************************************************************************/

CrdFmncPco::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCPCODO, scrJref) {
...
string CrdFmncPco::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncPco::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncPcoDo");
...
/******************************************************************************
 class CrdFmncPco::DpchEngData
 ******************************************************************************/

CrdFmncPco::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCPCODATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdFmncPco::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncPco::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncPcoData");
	else
		basefound = checkXPath(docctx, basexpath);
