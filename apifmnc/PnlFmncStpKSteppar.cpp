/**
  ...
  * API code for job PnlFmncStpKSteppar (implementation)
...
bool PnlFmncStpKSteppar::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncStpKSteppar";
...
PnlFmncStpKSteppar::StatApp::StatApp(
...
bool PnlFmncStpKSteppar::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncStpKSteppar";
...
set<uint> PnlFmncStpKSteppar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncStpKSteppar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlFmncStpKSteppar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncStpKSteppar";
...
bool PnlFmncStpKSteppar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncStpKSteppar";
...
PnlFmncStpKSteppar::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncStpKSteppar::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCSTPKSTEPPARDATA, scrJref) {
...
void PnlFmncStpKSteppar::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncStpKStepparData");
...
PnlFmncStpKSteppar::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCSTPKSTEPPARDO, scrJref) {
...
void PnlFmncStpKSteppar::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncStpKStepparDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncStpKSteppar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCSTPKSTEPPARDATA) {
...
void PnlFmncStpKSteppar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncStpKStepparData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncStpKSteppar::StatApp();
		statshrqry = QryFmncStpKSteppar::StatShr();
