/**
  ...
  * API code for job QryFmncTolSvcMNOrg (implementation)
...
/******************************************************************************
 class QryFmncTolSvcMNOrg::StatApp
 ******************************************************************************/

QryFmncTolSvcMNOrg::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncTolSvcMNOrg::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncTolSvcMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncTolSvcMNOrg";
...
set<uint> QryFmncTolSvcMNOrg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolSvcMNOrg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTolSvcMNOrg::StatShr
 ******************************************************************************/

QryFmncTolSvcMNOrg::StatShr::StatShr(
			const uint ntot
...
bool QryFmncTolSvcMNOrg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncTolSvcMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncTolSvcMNOrg";
...
set<uint> QryFmncTolSvcMNOrg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolSvcMNOrg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTolSvcMNOrg::StgIac
 ******************************************************************************/

QryFmncTolSvcMNOrg::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncTolSvcMNOrg::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncTolSvcMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncTolSvcMNOrg";
...
void QryFmncTolSvcMNOrg::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncTolSvcMNOrg";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncTolSvcMNOrg";
...
set<uint> QryFmncTolSvcMNOrg::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolSvcMNOrg::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
