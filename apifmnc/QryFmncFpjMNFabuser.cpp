/**
  ...
  * API code for job QryFmncFpjMNFabuser (implementation)
...
/******************************************************************************
 class QryFmncFpjMNFabuser::StatApp
 ******************************************************************************/

QryFmncFpjMNFabuser::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncFpjMNFabuser::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncFpjMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncFpjMNFabuser";
...
set<uint> QryFmncFpjMNFabuser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
/******************************************************************************
 class QryFmncFpjMNFabuser::StatShr
 ******************************************************************************/

QryFmncFpjMNFabuser::StatShr::StatShr(
			const uint ntot
...
bool QryFmncFpjMNFabuser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncFpjMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncFpjMNFabuser";
...
set<uint> QryFmncFpjMNFabuser::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFpjMNFabuser::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFpjMNFabuser::StgIac
 ******************************************************************************/

QryFmncFpjMNFabuser::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncFpjMNFabuser::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncFpjMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncFpjMNFabuser";
...
void QryFmncFpjMNFabuser::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncFpjMNFabuser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncFpjMNFabuser";
...
set<uint> QryFmncFpjMNFabuser::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
