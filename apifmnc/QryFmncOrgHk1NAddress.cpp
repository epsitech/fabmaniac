/**
  ...
  * API code for job QryFmncOrgHk1NAddress (implementation)
...
/******************************************************************************
 class QryFmncOrgHk1NAddress::StatApp
 ******************************************************************************/

QryFmncOrgHk1NAddress::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncOrgHk1NAddress::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncOrgHk1NAddress");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncOrgHk1NAddress";
...
set<uint> QryFmncOrgHk1NAddress::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgHk1NAddress::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgHk1NAddress::StatShr
 ******************************************************************************/

QryFmncOrgHk1NAddress::StatShr::StatShr(
			const uint ntot
...
bool QryFmncOrgHk1NAddress::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncOrgHk1NAddress");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncOrgHk1NAddress";
...
set<uint> QryFmncOrgHk1NAddress::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgHk1NAddress::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgHk1NAddress::StgIac
 ******************************************************************************/

QryFmncOrgHk1NAddress::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncOrgHk1NAddress::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncOrgHk1NAddress");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncOrgHk1NAddress";
...
void QryFmncOrgHk1NAddress::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncOrgHk1NAddress";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncOrgHk1NAddress";
...
set<uint> QryFmncOrgHk1NAddress::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgHk1NAddress::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
