/**
  ...
  * API code for job PnlFmncSepMNSample (implementation)
...
bool PnlFmncSepMNSample::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncSepMNSample");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncSepMNSample";
...
PnlFmncSepMNSample::StatApp::StatApp(
...
bool PnlFmncSepMNSample::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncSepMNSample");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncSepMNSample";
...
set<uint> PnlFmncSepMNSample::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncSepMNSample::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlFmncSepMNSample::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncSepMNSample");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncSepMNSample";
...
bool PnlFmncSepMNSample::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncSepMNSample");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncSepMNSample";
...
PnlFmncSepMNSample::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncSepMNSample::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCSEPMNSAMPLEDATA, scrJref) {
...
void PnlFmncSepMNSample::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncSepMNSampleData");
...
PnlFmncSepMNSample::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCSEPMNSAMPLEDO, scrJref) {
...
void PnlFmncSepMNSample::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncSepMNSampleDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncSepMNSample::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCSEPMNSAMPLEDATA) {
...
void PnlFmncSepMNSample::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncSepMNSampleData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncSepMNSample::StatApp();
		statshrqry = QryFmncSepMNSample::StatShr();
