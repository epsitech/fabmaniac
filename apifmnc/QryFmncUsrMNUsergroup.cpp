/**
  ...
  * API code for job QryFmncUsrMNUsergroup (implementation)
...
/******************************************************************************
 class QryFmncUsrMNUsergroup::StatApp
 ******************************************************************************/

QryFmncUsrMNUsergroup::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncUsrMNUsergroup::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncUsrMNUsergroup";
...
set<uint> QryFmncUsrMNUsergroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncUsrMNUsergroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncUsrMNUsergroup::StatShr
 ******************************************************************************/

QryFmncUsrMNUsergroup::StatShr::StatShr(
			const uint ntot
...
bool QryFmncUsrMNUsergroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncUsrMNUsergroup";
...
set<uint> QryFmncUsrMNUsergroup::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncUsrMNUsergroup::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncUsrMNUsergroup::StgIac
 ******************************************************************************/

QryFmncUsrMNUsergroup::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncUsrMNUsergroup::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncUsrMNUsergroup";
...
void QryFmncUsrMNUsergroup::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncUsrMNUsergroup";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncUsrMNUsergroup";
...
set<uint> QryFmncUsrMNUsergroup::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncUsrMNUsergroup::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
