/**
  ...
  * API code for job PnlFmncOrgList (declarations)
...
namespace PnlFmncOrgList {
	...
	public:
		...
		static const uint TCODRV = 7;
		static const uint TCOADR = 8;
		static const uint TCOSUP = 9;
		static const uint TCOTEL = 10;
		static const uint TCOEML = 11;

	public:
		Tag(const string& Cpt = "", const string& Trs = "", const string& TxtShowing1 = "", const string& TxtShowing2 = "", const string& TcoSrf = "", const string& TcoTit = "", const string& TcoDrv = "", const string& TcoAdr = "", const string& TcoSup = "", const string& TcoTel = "", const string& TcoEml = "");
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryFmncOrgList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncOrgList::StatApp statappqry;
