/**
  ...
  * API code for job QryFmncStpKSteppar (implementation)
...
/******************************************************************************
 class QryFmncStpKSteppar::StatApp
 ******************************************************************************/

QryFmncStpKSteppar::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncStpKSteppar::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncStpKSteppar";
...
set<uint> QryFmncStpKSteppar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncStpKSteppar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncStpKSteppar::StatShr
 ******************************************************************************/

QryFmncStpKSteppar::StatShr::StatShr(
			const uint ntot
...
bool QryFmncStpKSteppar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncStpKSteppar";
...
set<uint> QryFmncStpKSteppar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncStpKSteppar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncStpKSteppar::StgIac
 ******************************************************************************/

QryFmncStpKSteppar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncStpKSteppar::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncStpKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncStpKSteppar";
...
void QryFmncStpKSteppar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncStpKSteppar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncStpKSteppar";
...
set<uint> QryFmncStpKSteppar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncStpKSteppar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
