/**
  * \file QryFmncFab1NFabuser.cpp
  * API code for job QryFmncFab1NFabuser (implementation)
...
/******************************************************************************
 class QryFmncFab1NFabuser::StatApp
 ******************************************************************************/

QryFmncFab1NFabuser::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncFab1NFabuser::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncFab1NFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncFab1NFabuser";
...
set<uint> QryFmncFab1NFabuser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFab1NFabuser::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFab1NFabuser::StatShr
 ******************************************************************************/

QryFmncFab1NFabuser::StatShr::StatShr(
			const uint ntot
...
bool QryFmncFab1NFabuser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncFab1NFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncFab1NFabuser";
...
set<uint> QryFmncFab1NFabuser::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFab1NFabuser::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFab1NFabuser::StgIac
 ******************************************************************************/

QryFmncFab1NFabuser::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncFab1NFabuser::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncFab1NFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncFab1NFabuser";
...
void QryFmncFab1NFabuser::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncFab1NFabuser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncFab1NFabuser";
...
set<uint> QryFmncFab1NFabuser::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFab1NFabuser::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
