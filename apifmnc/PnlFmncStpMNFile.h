/**
  * \file PnlFmncStpMNFile.h
  * API code for job PnlFmncStpMNFile (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSTPMNFILE_H
#define PNLFMNCSTPMNFILE_H
...
/**
  * PnlFmncStpMNFile
  */
namespace PnlFmncStpMNFile {
	/**
		* VecVDo (full: VecVFmncStpMNFileDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncStpMNFile)
	  */
	...
	/**
	  * StatApp (full: StatAppFmncStpMNFile)
	  */
	...
	/**
	  * StatShr (full: StatShrFmncStpMNFile)
	  */
	...
	/**
	  * StgIac (full: StgIacFmncStpMNFile)
	  */
	...
	/**
		* DpchAppData (full: DpchAppFmncStpMNFileData)
		*/
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncStpMNFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	/**
		* DpchAppDo (full: DpchAppFmncStpMNFileDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncStpMNFileData)
		*/
	...
	public:
		...
		QryFmncStpMNFile::StatApp statappqry;
