/**
  ...
  * API code for job PnlFmncFusMNFabproject (declarations)
...
/**
  ...
  */
namespace PnlFmncFusMNFabproject {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncFusMNFabproject::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFusMNFabproject::StatApp statappqry;
