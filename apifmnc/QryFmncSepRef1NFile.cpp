/**
  ...
  * API code for job QryFmncSepRef1NFile (implementation)
...
/******************************************************************************
 class QryFmncSepRef1NFile::StatApp
 ******************************************************************************/

QryFmncSepRef1NFile::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncSepRef1NFile::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncSepRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncSepRef1NFile";
...
set<uint> QryFmncSepRef1NFile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncSepRef1NFile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncSepRef1NFile::StatShr
 ******************************************************************************/

QryFmncSepRef1NFile::StatShr::StatShr(
			const uint ntot
...
bool QryFmncSepRef1NFile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncSepRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncSepRef1NFile";
...
set<uint> QryFmncSepRef1NFile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncSepRef1NFile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncSepRef1NFile::StgIac
 ******************************************************************************/

QryFmncSepRef1NFile::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncSepRef1NFile::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncSepRef1NFile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncSepRef1NFile";
...
void QryFmncSepRef1NFile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncSepRef1NFile";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncSepRef1NFile";
...
set<uint> QryFmncSepRef1NFile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncSepRef1NFile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
