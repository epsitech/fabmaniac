/**
  ...
  * API code for job QryFmncFusMNFabproject (implementation)
...
/******************************************************************************
 class QryFmncFusMNFabproject::StatApp
 ******************************************************************************/

QryFmncFusMNFabproject::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncFusMNFabproject::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncFusMNFabproject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncFusMNFabproject";
...
set<uint> QryFmncFusMNFabproject::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFusMNFabproject::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFusMNFabproject::StatShr
 ******************************************************************************/

QryFmncFusMNFabproject::StatShr::StatShr(
			const uint ntot
...
bool QryFmncFusMNFabproject::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncFusMNFabproject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncFusMNFabproject";
...
set<uint> QryFmncFusMNFabproject::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFusMNFabproject::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFusMNFabproject::StgIac
 ******************************************************************************/

QryFmncFusMNFabproject::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncFusMNFabproject::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncFusMNFabproject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncFusMNFabproject";
...
void QryFmncFusMNFabproject::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncFusMNFabproject";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncFusMNFabproject";
...
set<uint> QryFmncFusMNFabproject::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFusMNFabproject::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
