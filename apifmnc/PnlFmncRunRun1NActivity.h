/**
  ...
  * API code for job PnlFmncRunRun1NActivity (declarations)
...
/**
  ...
  */
namespace PnlFmncRunRun1NActivity {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncRunRun1NActivity::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncRunRun1NActivity::StatApp statappqry;
