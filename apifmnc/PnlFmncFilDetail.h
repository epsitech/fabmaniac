/**
  ...
  * API code for job PnlFmncFilDetail (declarations)
...
namespace PnlFmncFilDetail {
	...
	public:
		StatApp(const uint ixFmncVExpstate = VecFmncVExpstate::MIND, const bool LstCluAlt = true, const bool PupCntAlt = false, const bool PupMimAlt = false, const uint LstCluNumFirstdisp = 1);
