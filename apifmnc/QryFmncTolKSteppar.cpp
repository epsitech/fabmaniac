/**
  ...
  * API code for job QryFmncTolKSteppar (implementation)
...
/******************************************************************************
 class QryFmncTolKSteppar::StatApp
 ******************************************************************************/

QryFmncTolKSteppar::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncTolKSteppar::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncTolKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncTolKSteppar";
...
set<uint> QryFmncTolKSteppar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolKSteppar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTolKSteppar::StatShr
 ******************************************************************************/

QryFmncTolKSteppar::StatShr::StatShr(
			const uint ntot
...
bool QryFmncTolKSteppar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncTolKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncTolKSteppar";
...
set<uint> QryFmncTolKSteppar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolKSteppar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTolKSteppar::StgIac
 ******************************************************************************/

QryFmncTolKSteppar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncTolKSteppar::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncTolKSteppar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncTolKSteppar";
...
void QryFmncTolKSteppar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncTolKSteppar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncTolKSteppar";
...
set<uint> QryFmncTolKSteppar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTolKSteppar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
