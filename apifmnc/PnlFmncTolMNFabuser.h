/**
  ...
  * API code for job PnlFmncTolMNFabuser (declarations)
...
namespace PnlFmncTolMNFabuser {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncTolMNFabuser::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTolMNFabuser::StatApp statappqry;
