/**
  ...
  * API code for job QryFmncOrgSup1NOrg (implementation)
...
/******************************************************************************
 class QryFmncOrgSup1NOrg::StatApp
 ******************************************************************************/

QryFmncOrgSup1NOrg::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncOrgSup1NOrg::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncOrgSup1NOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncOrgSup1NOrg";
...
set<uint> QryFmncOrgSup1NOrg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgSup1NOrg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgSup1NOrg::StatShr
 ******************************************************************************/

QryFmncOrgSup1NOrg::StatShr::StatShr(
			const uint ntot
...
bool QryFmncOrgSup1NOrg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncOrgSup1NOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncOrgSup1NOrg";
...
set<uint> QryFmncOrgSup1NOrg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgSup1NOrg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgSup1NOrg::StgIac
 ******************************************************************************/

QryFmncOrgSup1NOrg::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncOrgSup1NOrg::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncOrgSup1NOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncOrgSup1NOrg";
...
void QryFmncOrgSup1NOrg::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncOrgSup1NOrg";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncOrgSup1NOrg";
...
set<uint> QryFmncOrgSup1NOrg::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgSup1NOrg::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
