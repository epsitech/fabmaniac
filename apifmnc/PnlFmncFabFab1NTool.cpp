/**
  ...
  * API code for job PnlFmncFabFab1NTool (implementation)
...
bool PnlFmncFabFab1NTool::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncFabFab1NTool";
...
PnlFmncFabFab1NTool::StatApp::StatApp(
...
bool PnlFmncFabFab1NTool::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncFabFab1NTool";
...
set<uint> PnlFmncFabFab1NTool::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncFabFab1NTool::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlFmncFabFab1NTool::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncFabFab1NTool";
...
bool PnlFmncFabFab1NTool::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncFabFab1NTool";
...
PnlFmncFabFab1NTool::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncFabFab1NTool::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCFABFAB1NTOOLDATA, scrJref) {
...
void PnlFmncFabFab1NTool::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncFabFab1NToolData");
...
PnlFmncFabFab1NTool::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCFABFAB1NTOOLDO, scrJref) {
...
void PnlFmncFabFab1NTool::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncFabFab1NToolDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncFabFab1NTool::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCFABFAB1NTOOLDATA) {
...
void PnlFmncFabFab1NTool::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncFabFab1NToolData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncFabFab1NTool::StatApp();
		statshrqry = QryFmncFabFab1NTool::StatShr();
