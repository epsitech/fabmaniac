/**
  * \file PnlFmncUsrHeadbar.h
  * API code for job PnlFmncUsrHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCUSRHEADBAR_H
#define PNLFMNCUSRHEADBAR_H
...
/**
  * PnlFmncUsrHeadbar
  */
namespace PnlFmncUsrHeadbar {
	/**
	  * StgInf (full: StgInfFmncUsrHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngFmncUsrHeadbarData)
		*/
