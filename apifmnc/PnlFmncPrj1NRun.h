/**
  ...
  * API code for job PnlFmncPrj1NRun (declarations)
...
namespace PnlFmncPrj1NRun {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncPrj1NRun::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncPrj1NRun::StatApp statappqry;
