/**
  ...
  * API code for job QryFmncOrgMnf1NTool (implementation)
...
/******************************************************************************
 class QryFmncOrgMnf1NTool::StatApp
 ******************************************************************************/

QryFmncOrgMnf1NTool::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncOrgMnf1NTool::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncOrgMnf1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncOrgMnf1NTool";
...
set<uint> QryFmncOrgMnf1NTool::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgMnf1NTool::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgMnf1NTool::StatShr
 ******************************************************************************/

QryFmncOrgMnf1NTool::StatShr::StatShr(
			const uint ntot
...
bool QryFmncOrgMnf1NTool::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncOrgMnf1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncOrgMnf1NTool";
...
set<uint> QryFmncOrgMnf1NTool::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgMnf1NTool::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgMnf1NTool::StgIac
 ******************************************************************************/

QryFmncOrgMnf1NTool::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncOrgMnf1NTool::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncOrgMnf1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncOrgMnf1NTool";
...
void QryFmncOrgMnf1NTool::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncOrgMnf1NTool";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncOrgMnf1NTool";
...
set<uint> QryFmncOrgMnf1NTool::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgMnf1NTool::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
