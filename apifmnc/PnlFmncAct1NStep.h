/**
  ...
  * API code for job PnlFmncAct1NStep (declarations)
...
namespace PnlFmncAct1NStep {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncAct1NStep::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncAct1NStep::StatApp statappqry;
