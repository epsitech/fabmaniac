/**
  ...
  * API code for job QryFmncOrgSvcMNTool (implementation)
...
/******************************************************************************
 class QryFmncOrgSvcMNTool::StatApp
 ******************************************************************************/

QryFmncOrgSvcMNTool::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncOrgSvcMNTool::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncOrgSvcMNTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncOrgSvcMNTool";
...
set<uint> QryFmncOrgSvcMNTool::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgSvcMNTool::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgSvcMNTool::StatShr
 ******************************************************************************/

QryFmncOrgSvcMNTool::StatShr::StatShr(
			const uint ntot
...
bool QryFmncOrgSvcMNTool::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncOrgSvcMNTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncOrgSvcMNTool";
...
set<uint> QryFmncOrgSvcMNTool::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgSvcMNTool::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgSvcMNTool::StgIac
 ******************************************************************************/

QryFmncOrgSvcMNTool::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncOrgSvcMNTool::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncOrgSvcMNTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncOrgSvcMNTool";
...
void QryFmncOrgSvcMNTool::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncOrgSvcMNTool";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncOrgSvcMNTool";
...
set<uint> QryFmncOrgSvcMNTool::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgSvcMNTool::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
