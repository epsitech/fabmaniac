/**
  ...
  * API code for job PnlFmncOrgKStocklcn (implementation)
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::VecVDo
 ******************************************************************************/

uint PnlFmncOrgKStocklcn::VecVDo::getIx(
			const string& sref
		) {
...
string PnlFmncOrgKStocklcn::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::ContInf
 ******************************************************************************/

PnlFmncOrgKStocklcn::ContInf::ContInf(
...
bool PnlFmncOrgKStocklcn::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncOrgKStocklcn";
...
set<uint> PnlFmncOrgKStocklcn::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncOrgKStocklcn::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::StatApp
 ******************************************************************************/

PnlFmncOrgKStocklcn::StatApp::StatApp(
...
bool PnlFmncOrgKStocklcn::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncOrgKStocklcn";
...
set<uint> PnlFmncOrgKStocklcn::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncOrgKStocklcn::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::StatShr
 ******************************************************************************/

PnlFmncOrgKStocklcn::StatShr::StatShr(
...
bool PnlFmncOrgKStocklcn::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncOrgKStocklcn";
...
set<uint> PnlFmncOrgKStocklcn::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncOrgKStocklcn::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::StgIac
 ******************************************************************************/

PnlFmncOrgKStocklcn::StgIac::StgIac(
...
bool PnlFmncOrgKStocklcn::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacFmncOrgKStocklcn";
...
void PnlFmncOrgKStocklcn::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacFmncOrgKStocklcn";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacFmncOrgKStocklcn";
...
set<uint> PnlFmncOrgKStocklcn::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncOrgKStocklcn::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::Tag
 ******************************************************************************/

PnlFmncOrgKStocklcn::Tag::Tag(
			const string& Cpt
			, const string& Trs
...
bool PnlFmncOrgKStocklcn::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncOrgKStocklcn";
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::DpchAppData
 ******************************************************************************/

PnlFmncOrgKStocklcn::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncOrgKStocklcn::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGKSTOCKLCNDATA, scrJref) {
...
string PnlFmncOrgKStocklcn::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncOrgKStocklcn::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncOrgKStocklcnData");
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::DpchAppDo
 ******************************************************************************/

PnlFmncOrgKStocklcn::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGKSTOCKLCNDO, scrJref) {
...
string PnlFmncOrgKStocklcn::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncOrgKStocklcn::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncOrgKStocklcnDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
/******************************************************************************
 class PnlFmncOrgKStocklcn::DpchEngData
 ******************************************************************************/

PnlFmncOrgKStocklcn::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCORGKSTOCKLCNDATA) {
	feedFCsiQst.tag = "FeedFCsiQst";
};

string PnlFmncOrgKStocklcn::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncOrgKStocklcn::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncOrgKStocklcnData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncOrgKStocklcn::StatApp();
		statshrqry = QryFmncOrgKStocklcn::StatShr();
		stgiacqry = QryFmncOrgKStocklcn::StgIac();
	};
};
