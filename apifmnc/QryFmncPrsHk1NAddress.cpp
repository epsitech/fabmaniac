/**
  ...
  * API code for job QryFmncPrsHk1NAddress (implementation)
...
/******************************************************************************
 class QryFmncPrsHk1NAddress::StatApp
 ******************************************************************************/

QryFmncPrsHk1NAddress::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncPrsHk1NAddress::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncPrsHk1NAddress");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncPrsHk1NAddress";
...
set<uint> QryFmncPrsHk1NAddress::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncPrsHk1NAddress::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncPrsHk1NAddress::StatShr
 ******************************************************************************/

QryFmncPrsHk1NAddress::StatShr::StatShr(
			const uint ntot
...
bool QryFmncPrsHk1NAddress::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncPrsHk1NAddress");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncPrsHk1NAddress";
...
set<uint> QryFmncPrsHk1NAddress::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncPrsHk1NAddress::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncPrsHk1NAddress::StgIac
 ******************************************************************************/

QryFmncPrsHk1NAddress::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncPrsHk1NAddress::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncPrsHk1NAddress");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncPrsHk1NAddress";
...
void QryFmncPrsHk1NAddress::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncPrsHk1NAddress";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncPrsHk1NAddress";
...
set<uint> QryFmncPrsHk1NAddress::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncPrsHk1NAddress::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
