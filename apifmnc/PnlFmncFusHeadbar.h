/**
  * \file PnlFmncFusHeadbar.h
  * API code for job PnlFmncFusHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFUSHEADBAR_H
#define PNLFMNCFUSHEADBAR_H
...
/**
  * PnlFmncFusHeadbar
  */
namespace PnlFmncFusHeadbar {
	/**
	  * StgInf (full: StgInfFmncFusHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngFmncFusHeadbarData)
		*/
