/**
  ...
  * API code for job PnlFmncTolMNFabuser (implementation)
...
bool PnlFmncTolMNFabuser::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncTolMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncTolMNFabuser";
...
PnlFmncTolMNFabuser::StatApp::StatApp(
...
bool PnlFmncTolMNFabuser::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncTolMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncTolMNFabuser";
...
set<uint> PnlFmncTolMNFabuser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncTolMNFabuser::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlFmncTolMNFabuser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncTolMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncTolMNFabuser";
...
bool PnlFmncTolMNFabuser::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncTolMNFabuser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncTolMNFabuser";
...
PnlFmncTolMNFabuser::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncTolMNFabuser::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCTOLMNFABUSERDATA, scrJref) {
...
void PnlFmncTolMNFabuser::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncTolMNFabuserData");
...
PnlFmncTolMNFabuser::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCTOLMNFABUSERDO, scrJref) {
...
void PnlFmncTolMNFabuser::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncTolMNFabuserDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncTolMNFabuser::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCTOLMNFABUSERDATA) {
...
void PnlFmncTolMNFabuser::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncTolMNFabuserData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncTolMNFabuser::StatApp();
		statshrqry = QryFmncTolMNFabuser::StatShr();
