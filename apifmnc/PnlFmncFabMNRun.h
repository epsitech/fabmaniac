/**
  ...
  * API code for job PnlFmncFabMNRun (declarations)
...
namespace PnlFmncFabMNRun {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncFabMNRun::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFabMNRun::StatApp statappqry;
