/**
  ...
  * API code for job PnlFmncSepMNFile (declarations)
...
namespace PnlFmncSepMNFile {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncSepMNFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSepMNFile::StatApp statappqry;
