/**
  * \file CrdFmncFil.cpp
  * API code for job CrdFmncFil (implementation)
...
/******************************************************************************
 class CrdFmncFil::VecVDo
 ******************************************************************************/

uint CrdFmncFil::VecVDo::getIx(
			const string& sref
		) {
...
string CrdFmncFil::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncFil::VecVSge
 ******************************************************************************/

uint CrdFmncFil::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdFmncFil::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncFil::ContInf
 ******************************************************************************/

CrdFmncFil::ContInf::ContInf(
			const uint numFSge
...
bool CrdFmncFil::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncFil";
...
set<uint> CrdFmncFil::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncFil::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncFil::StatApp
 ******************************************************************************/

CrdFmncFil::StatApp::StatApp(
...
bool CrdFmncFil::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncFil";
...
set<uint> CrdFmncFil::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncFil::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncFil::StatShr
 ******************************************************************************/

CrdFmncFil::StatShr::StatShr(
...
bool CrdFmncFil::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncFil";
...
set<uint> CrdFmncFil::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncFil::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdFmncFil::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncFil");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncFil";
...
/******************************************************************************
 class CrdFmncFil::DpchAppDo
 ******************************************************************************/

CrdFmncFil::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCFILDO, scrJref) {
...
string CrdFmncFil::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncFil::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncFilDo");
...
/******************************************************************************
 class CrdFmncFil::DpchEngData
 ******************************************************************************/

CrdFmncFil::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCFILDATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdFmncFil::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncFil::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncFilData");
	else
		basefound = checkXPath(docctx, basexpath);
