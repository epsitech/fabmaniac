/**
  ...
  * API code for job PnlFmncTtyKToolchar (implementation)
...
bool PnlFmncTtyKToolchar::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncTtyKToolchar";
...
PnlFmncTtyKToolchar::StatApp::StatApp(
...
bool PnlFmncTtyKToolchar::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncTtyKToolchar";
...
set<uint> PnlFmncTtyKToolchar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncTtyKToolchar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlFmncTtyKToolchar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncTtyKToolchar";
...
bool PnlFmncTtyKToolchar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncTtyKToolchar";
...
PnlFmncTtyKToolchar::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncTtyKToolchar::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCTTYKTOOLCHARDATA, scrJref) {
...
void PnlFmncTtyKToolchar::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncTtyKToolcharData");
...
PnlFmncTtyKToolchar::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCTTYKTOOLCHARDO, scrJref) {
...
void PnlFmncTtyKToolchar::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncTtyKToolcharDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncTtyKToolchar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCTTYKTOOLCHARDATA) {
...
void PnlFmncTtyKToolchar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncTtyKToolcharData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncTtyKToolchar::StatApp();
		statshrqry = QryFmncTtyKToolchar::StatShr();
