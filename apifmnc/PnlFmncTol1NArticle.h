/**
  ...
  * API code for job PnlFmncTol1NArticle (declarations)
...
namespace PnlFmncTol1NArticle {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncTol1NArticle::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTol1NArticle::StatApp statappqry;
