/**
  ...
  * API code for job PnlFmncTolKSteppar (declarations)
...
namespace PnlFmncTolKSteppar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncTolKSteppar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTolKSteppar::StatApp statappqry;
