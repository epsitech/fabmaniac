/**
  * \file PnlFmncFilHeadbar.cpp
  * API code for job PnlFmncFilHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncFilHeadbar::StgInf
 ******************************************************************************/

PnlFmncFilHeadbar::StgInf::StgInf(
...
bool PnlFmncFilHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncFilHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncFilHeadbar";
...
set<uint> PnlFmncFilHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncFilHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncFilHeadbar::Tag
 ******************************************************************************/

PnlFmncFilHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncFilHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncFilHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncFilHeadbar";
...
/******************************************************************************
 class PnlFmncFilHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncFilHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCFILHEADBARDATA) {
};

string PnlFmncFilHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncFilHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncFilHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
