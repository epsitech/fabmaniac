/**
  ...
  * API code for job PnlFmncFabFab1NTool (declarations)
...
namespace PnlFmncFabFab1NTool {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncFabFab1NTool::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFabFab1NTool::StatApp statappqry;
