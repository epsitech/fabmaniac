/**
  ...
  * API code for job PnlFmncSepMNSample (declarations)
...
namespace PnlFmncSepMNSample {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncSepMNSample::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSepMNSample::StatApp statappqry;
