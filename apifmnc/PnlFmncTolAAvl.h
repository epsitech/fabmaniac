/**
  ...
  * API code for job PnlFmncTolAAvl (declarations)
...
namespace PnlFmncTolAAvl {
	...
	public:
		...
		static const uint TCODAT = 5;
		static const uint TCOWDY = 6;
		static const uint TCOSTA = 7;
		static const uint TCOSTO = 8;
		static const uint TCOATY = 9;

	public:
		Tag(const string& Cpt = "", const string& Trs = "", const string& TxtShowing1 = "", const string& TxtShowing2 = "", const string& TcoDat = "", const string& TcoWdy = "", const string& TcoSta = "", const string& TcoSto = "", const string& TcoAty = "");
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncTolAAvl::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTolAAvl::StatApp statappqry;
