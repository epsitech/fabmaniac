/**
  ...
  * API code for job PnlFmncArtMNOrg (implementation)
...
bool PnlFmncArtMNOrg::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncArtMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncArtMNOrg";
...
PnlFmncArtMNOrg::StatApp::StatApp(
...
bool PnlFmncArtMNOrg::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncArtMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncArtMNOrg";
...
set<uint> PnlFmncArtMNOrg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncArtMNOrg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlFmncArtMNOrg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncArtMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncArtMNOrg";
...
bool PnlFmncArtMNOrg::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncArtMNOrg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncArtMNOrg";
...
PnlFmncArtMNOrg::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryFmncArtMNOrg::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCARTMNORGDATA, scrJref) {
...
void PnlFmncArtMNOrg::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncArtMNOrgData");
...
PnlFmncArtMNOrg::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCARTMNORGDO, scrJref) {
...
void PnlFmncArtMNOrg::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncArtMNOrgDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncArtMNOrg::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCARTMNORGDATA) {
...
void PnlFmncArtMNOrg::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncArtMNOrgData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncArtMNOrg::StatApp();
		statshrqry = QryFmncArtMNOrg::StatShr();
