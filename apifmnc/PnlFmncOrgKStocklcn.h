/**
  ...
  * API code for job PnlFmncOrgKStocklcn (declarations)
...
namespace PnlFmncOrgKStocklcn {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncOrgKStocklcn::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncOrgKStocklcn::StatApp statappqry;
