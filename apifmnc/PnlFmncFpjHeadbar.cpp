/**
  * \file PnlFmncFpjHeadbar.cpp
  * API code for job PnlFmncFpjHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncFpjHeadbar::StgInf
 ******************************************************************************/

PnlFmncFpjHeadbar::StgInf::StgInf(
...
bool PnlFmncFpjHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncFpjHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncFpjHeadbar";
...
set<uint> PnlFmncFpjHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncFpjHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncFpjHeadbar::Tag
 ******************************************************************************/

PnlFmncFpjHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncFpjHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncFpjHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncFpjHeadbar";
...
/******************************************************************************
 class PnlFmncFpjHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncFpjHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCFPJHEADBARDATA) {
};

string PnlFmncFpjHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncFpjHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncFpjHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
