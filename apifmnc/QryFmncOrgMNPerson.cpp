/**
  ...
  * API code for job QryFmncOrgMNPerson (implementation)
...
/******************************************************************************
 class QryFmncOrgMNPerson::StatApp
 ******************************************************************************/

QryFmncOrgMNPerson::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncOrgMNPerson::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncOrgMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncOrgMNPerson";
...
set<uint> QryFmncOrgMNPerson::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgMNPerson::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgMNPerson::StatShr
 ******************************************************************************/

QryFmncOrgMNPerson::StatShr::StatShr(
			const uint ntot
...
bool QryFmncOrgMNPerson::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncOrgMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncOrgMNPerson";
...
set<uint> QryFmncOrgMNPerson::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgMNPerson::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgMNPerson::StgIac
 ******************************************************************************/

QryFmncOrgMNPerson::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncOrgMNPerson::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncOrgMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncOrgMNPerson";
...
void QryFmncOrgMNPerson::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncOrgMNPerson";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncOrgMNPerson";
...
set<uint> QryFmncOrgMNPerson::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgMNPerson::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
