/**
  ...
  * API code for job QryFmncRunList (implementation)
...
/******************************************************************************
 class QryFmncRunList::VecVOrd
 ******************************************************************************/

uint QryFmncRunList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryFmncRunList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryFmncRunList::StatApp
 ******************************************************************************/

QryFmncRunList::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncRunList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncRunList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncRunList";
...
set<uint> QryFmncRunList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncRunList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncRunList::StatShr
 ******************************************************************************/

QryFmncRunList::StatShr::StatShr(
			const uint ntot
...
bool QryFmncRunList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncRunList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncRunList";
...
set<uint> QryFmncRunList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncRunList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncRunList::StgIac
 ******************************************************************************/

QryFmncRunList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncRunList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncRunList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncRunList";
...
void QryFmncRunList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncRunList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncRunList";
...
set<uint> QryFmncRunList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncRunList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
