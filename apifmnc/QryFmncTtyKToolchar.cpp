/**
  ...
  * API code for job QryFmncTtyKToolchar (implementation)
...
/******************************************************************************
 class QryFmncTtyKToolchar::StatApp
 ******************************************************************************/

QryFmncTtyKToolchar::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncTtyKToolchar::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncTtyKToolchar";
...
set<uint> QryFmncTtyKToolchar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTtyKToolchar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTtyKToolchar::StatShr
 ******************************************************************************/

QryFmncTtyKToolchar::StatShr::StatShr(
			const uint ntot
...
bool QryFmncTtyKToolchar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncTtyKToolchar";
...
set<uint> QryFmncTtyKToolchar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTtyKToolchar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncTtyKToolchar::StgIac
 ******************************************************************************/

QryFmncTtyKToolchar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncTtyKToolchar::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncTtyKToolchar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncTtyKToolchar";
...
void QryFmncTtyKToolchar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncTtyKToolchar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncTtyKToolchar";
...
set<uint> QryFmncTtyKToolchar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncTtyKToolchar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
