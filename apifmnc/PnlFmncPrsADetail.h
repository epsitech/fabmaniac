/**
  ...
  * API code for job PnlFmncPrsADetail (declarations)
...
namespace PnlFmncPrsADetail {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncPrsADetail::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncPrsADetail::StatApp statappqry;
