/**
  ...
  * API code for job QryFmncFabFab1NTool (implementation)
...
/******************************************************************************
 class QryFmncFabFab1NTool::StatApp
 ******************************************************************************/

QryFmncFabFab1NTool::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncFabFab1NTool::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncFabFab1NTool";
...
set<uint> QryFmncFabFab1NTool::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFabFab1NTool::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFabFab1NTool::StatShr
 ******************************************************************************/

QryFmncFabFab1NTool::StatShr::StatShr(
			const uint ntot
...
bool QryFmncFabFab1NTool::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncFabFab1NTool";
...
set<uint> QryFmncFabFab1NTool::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFabFab1NTool::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncFabFab1NTool::StgIac
 ******************************************************************************/

QryFmncFabFab1NTool::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncFabFab1NTool::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncFabFab1NTool");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncFabFab1NTool";
...
void QryFmncFabFab1NTool::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncFabFab1NTool";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncFabFab1NTool";
...
set<uint> QryFmncFabFab1NTool::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncFabFab1NTool::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
