/**
  * \file PnlFmncPcoHeadbar.cpp
  * API code for job PnlFmncPcoHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncPcoHeadbar::StgInf
 ******************************************************************************/

PnlFmncPcoHeadbar::StgInf::StgInf(
...
bool PnlFmncPcoHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncPcoHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncPcoHeadbar";
...
set<uint> PnlFmncPcoHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncPcoHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncPcoHeadbar::Tag
 ******************************************************************************/

PnlFmncPcoHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncPcoHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncPcoHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncPcoHeadbar";
...
/******************************************************************************
 class PnlFmncPcoHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncPcoHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCPCOHEADBARDATA) {
};

string PnlFmncPcoHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncPcoHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncPcoHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
