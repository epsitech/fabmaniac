/**
  ...
  * API code for job QryFmncUsgMNUser (implementation)
...
/******************************************************************************
 class QryFmncUsgMNUser::StatApp
 ******************************************************************************/

QryFmncUsgMNUser::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncUsgMNUser::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncUsgMNUser";
...
set<uint> QryFmncUsgMNUser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncUsgMNUser::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncUsgMNUser::StatShr
 ******************************************************************************/

QryFmncUsgMNUser::StatShr::StatShr(
			const uint ntot
...
bool QryFmncUsgMNUser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncUsgMNUser";
...
set<uint> QryFmncUsgMNUser::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncUsgMNUser::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncUsgMNUser::StgIac
 ******************************************************************************/

QryFmncUsgMNUser::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncUsgMNUser::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncUsgMNUser";
...
void QryFmncUsgMNUser::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncUsgMNUser";
...
set<uint> QryFmncUsgMNUser::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncUsgMNUser::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
