/**
  * \file PnlFmncUsgHeadbar.cpp
  * API code for job PnlFmncUsgHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncUsgHeadbar::StgInf
 ******************************************************************************/

PnlFmncUsgHeadbar::StgInf::StgInf(
...
bool PnlFmncUsgHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncUsgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncUsgHeadbar";
...
set<uint> PnlFmncUsgHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncUsgHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncUsgHeadbar::Tag
 ******************************************************************************/

PnlFmncUsgHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncUsgHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncUsgHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncUsgHeadbar";
...
/******************************************************************************
 class PnlFmncUsgHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncUsgHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCUSGHEADBARDATA) {
};

string PnlFmncUsgHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncUsgHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncUsgHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
