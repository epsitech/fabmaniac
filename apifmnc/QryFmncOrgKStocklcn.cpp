/**
  ...
  * API code for job QryFmncOrgKStocklcn (implementation)
...
/******************************************************************************
 class QryFmncOrgKStocklcn::StatApp
 ******************************************************************************/

QryFmncOrgKStocklcn::StatApp::StatApp(
			const uint firstcol
...
bool QryFmncOrgKStocklcn::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryFmncOrgKStocklcn";
...
set<uint> QryFmncOrgKStocklcn::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgKStocklcn::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgKStocklcn::StatShr
 ******************************************************************************/

QryFmncOrgKStocklcn::StatShr::StatShr(
			const uint ntot
...
bool QryFmncOrgKStocklcn::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryFmncOrgKStocklcn";
...
set<uint> QryFmncOrgKStocklcn::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgKStocklcn::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryFmncOrgKStocklcn::StgIac
 ******************************************************************************/

QryFmncOrgKStocklcn::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryFmncOrgKStocklcn::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryFmncOrgKStocklcn");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryFmncOrgKStocklcn";
...
void QryFmncOrgKStocklcn::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryFmncOrgKStocklcn";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryFmncOrgKStocklcn";
...
set<uint> QryFmncOrgKStocklcn::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryFmncOrgKStocklcn::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
