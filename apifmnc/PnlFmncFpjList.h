/**
  ...
  * API code for job PnlFmncFpjList (declarations)
...
namespace PnlFmncFpjList {
	...
	public:
		...
		static const uint TCOBIO = 9;
		static const uint TCOSTE = 10;

	public:
		Tag(const string& Cpt = "", const string& TxtFor = "", const string& Trs = "", const string& TxtShowing1 = "", const string& TxtShowing2 = "", const string& TcoSrf = "", const string& TcoTit = "", const string& TcoFab = "", const string& TcoBio = "", const string& TcoSte = "");
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryFmncFpjList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFpjList::StatApp statappqry;
