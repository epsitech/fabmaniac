/**
  * \file PnlFmncStpHeadbar.cpp
  * API code for job PnlFmncStpHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncStpHeadbar::StgInf
 ******************************************************************************/

PnlFmncStpHeadbar::StgInf::StgInf(
...
bool PnlFmncStpHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncStpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncStpHeadbar";
...
set<uint> PnlFmncStpHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncStpHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncStpHeadbar::Tag
 ******************************************************************************/

PnlFmncStpHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncStpHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncStpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncStpHeadbar";
...
/******************************************************************************
 class PnlFmncStpHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncStpHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCSTPHEADBARDATA) {
};

string PnlFmncStpHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncStpHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncStpHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
