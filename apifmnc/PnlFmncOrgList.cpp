/**
  ...
  * API code for job PnlFmncOrgList (implementation)
...
bool PnlFmncOrgList::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncOrgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncOrgList";
...
bool PnlFmncOrgList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncOrgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncOrgList";
...
PnlFmncOrgList::Tag::Tag(
	...
	mask = {CPT, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCODRV, TCOADR, TCOSUP, TCOTEL, TCOEML};
};

bool PnlFmncOrgList::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncOrgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncOrgList";
...
PnlFmncOrgList::DpchAppData::DpchAppData(
			const string& scrJref
			, ContIac* contiac
			, StgIac* stgiac
			, QryFmncOrgList::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGLISTDATA, scrJref) {
...
void PnlFmncOrgList::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncOrgListData");
...
PnlFmncOrgList::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGLISTDO, scrJref) {
...
void PnlFmncOrgList::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncOrgListDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlFmncOrgList::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCORGLISTDATA) {
...
void PnlFmncOrgList::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncOrgListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryFmncOrgList::StatApp();
		statshrqry = QryFmncOrgList::StatShr();
