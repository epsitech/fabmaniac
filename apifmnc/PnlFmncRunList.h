/**
  ...
  * API code for job PnlFmncRunList (declarations)
...
namespace PnlFmncRunList {
	...
	public:
		...
		static const uint TCOPRJ = 6;
		static const uint TCOSTE = 7;

	public:
		Tag(const string& Cpt = "", const string& Trs = "", const string& TxtShowing1 = "", const string& TxtShowing2 = "", const string& TcoTit = "", const string& TcoPrj = "", const string& TcoSte = "");
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryFmncRunList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncRunList::StatApp statappqry;
