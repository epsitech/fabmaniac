/**
  * \file CrdFmncSep.cpp
  * API code for job CrdFmncSep (implementation)
...
/******************************************************************************
 class CrdFmncSep::VecVDo
 ******************************************************************************/

uint CrdFmncSep::VecVDo::getIx(
			const string& sref
		) {
...
string CrdFmncSep::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncSep::VecVSge
 ******************************************************************************/

uint CrdFmncSep::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdFmncSep::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdFmncSep::ContInf
 ******************************************************************************/

CrdFmncSep::ContInf::ContInf(
			const uint numFSge
			, const string& MrlAppHlp
			, const string& MtxCrdSep
		) : Block() {
	this->numFSge = numFSge;
	this->MrlAppHlp = MrlAppHlp;
	this->MtxCrdSep = MtxCrdSep;

	mask = {NUMFSGE, MRLAPPHLP, MTXCRDSEP};
};

bool CrdFmncSep::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfFmncSep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfFmncSep";

	if (basefound) {
		if (extractUintAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "numFSge", numFSge)) add(NUMFSGE);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MrlAppHlp", MrlAppHlp)) add(MRLAPPHLP);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MtxCrdSep", MtxCrdSep)) add(MTXCRDSEP);
	};

	return basefound;
};

set<uint> CrdFmncSep::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdSep.compare(comp->MtxCrdSep) == 0) insert(items, MTXCRDSEP);

	return(items);
};

set<uint> CrdFmncSep::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {NUMFSGE, MRLAPPHLP, MTXCRDSEP};
...
/******************************************************************************
 class CrdFmncSep::StatApp
 ******************************************************************************/

CrdFmncSep::StatApp::StatApp(
...
bool CrdFmncSep::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppFmncSep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppFmncSep";
...
set<uint> CrdFmncSep::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncSep::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdFmncSep::StatShr
 ******************************************************************************/

CrdFmncSep::StatShr::StatShr(
...
bool CrdFmncSep::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrFmncSep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrFmncSep";
...
set<uint> CrdFmncSep::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdFmncSep::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdFmncSep::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncSep");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncSep";
...
/******************************************************************************
 class CrdFmncSep::DpchAppDo
 ******************************************************************************/

CrdFmncSep::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCSEPDO, scrJref) {
...
string CrdFmncSep::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncSep::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppFmncSepDo");
...
/******************************************************************************
 class CrdFmncSep::DpchEngData
 ******************************************************************************/

CrdFmncSep::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCSEPDATA) {
	feedFSge.tag = "FeedFSge";
};

string CrdFmncSep::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void CrdFmncSep::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncSepData");
	else
		basefound = checkXPath(docctx, basexpath);
