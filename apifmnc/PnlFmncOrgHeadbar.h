/**
  * \file PnlFmncOrgHeadbar.h
  * API code for job PnlFmncOrgHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCORGHEADBAR_H
#define PNLFMNCORGHEADBAR_H
...
/**
  * PnlFmncOrgHeadbar
  */
namespace PnlFmncOrgHeadbar {
	/**
	  * StgInf (full: StgInfFmncOrgHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngFmncOrgHeadbarData)
		*/
