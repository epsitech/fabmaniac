/**
  ...
  * API code for job PnlFmncStpKSteppar (declarations)
...
namespace PnlFmncStpKSteppar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryFmncStpKSteppar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncStpKSteppar::StatApp statappqry;
