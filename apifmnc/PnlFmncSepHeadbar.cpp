/**
  * \file PnlFmncSepHeadbar.cpp
  * API code for job PnlFmncSepHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncSepHeadbar::StgInf
 ******************************************************************************/

PnlFmncSepHeadbar::StgInf::StgInf(
...
bool PnlFmncSepHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncSepHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncSepHeadbar";
...
set<uint> PnlFmncSepHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncSepHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncSepHeadbar::Tag
 ******************************************************************************/

PnlFmncSepHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncSepHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncSepHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncSepHeadbar";
...
/******************************************************************************
 class PnlFmncSepHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncSepHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCSEPHEADBARDATA) {
};

string PnlFmncSepHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncSepHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncSepHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
