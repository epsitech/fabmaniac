/**
  * \file PnlFmncUsrHeadbar.cpp
  * API code for job PnlFmncUsrHeadbar (implementation)
...
/******************************************************************************
 class PnlFmncUsrHeadbar::StgInf
 ******************************************************************************/

PnlFmncUsrHeadbar::StgInf::StgInf(
...
bool PnlFmncUsrHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfFmncUsrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfFmncUsrHeadbar";
...
set<uint> PnlFmncUsrHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlFmncUsrHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlFmncUsrHeadbar::Tag
 ******************************************************************************/

PnlFmncUsrHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) : Block() {
	this->MenApp = MenApp;
...
bool PnlFmncUsrHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagFmncUsrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemFmncUsrHeadbar";
...
/******************************************************************************
 class PnlFmncUsrHeadbar::DpchEngData
 ******************************************************************************/

PnlFmncUsrHeadbar::DpchEngData::DpchEngData() : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCUSRHEADBARDATA) {
};

string PnlFmncUsrHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlFmncUsrHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngFmncUsrHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
