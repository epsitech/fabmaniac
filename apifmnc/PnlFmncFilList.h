/**
  ...
  * API code for job PnlFmncFilList (declarations)
...
namespace PnlFmncFilList {
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryFmncFilList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFilList::StatApp statappqry;
