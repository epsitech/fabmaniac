/**
  * \file PnlFmncTtySup1NTooltype.js
  * web client functionality for panel PnlFmncTtySup1NTooltype
...
// IP minimize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncTtySup1NTooltype", "srefIxFmncVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppFmncTtySup1NTooltype", "srefIxFmncVExpstate", "mind");

// IP minimize.estapp --- END
	getRecwnd().changeHeight("Sup1NTooltype", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Sup1NTooltype_side").setAttribute("height", "30");
	doc.getElementById("Sup1NTooltype_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Sup1NTooltype_side").src = "./PnlFmncTtySup1NTooltype_aside.html";
	doc.getElementById("Sup1NTooltype_cont").src = "./PnlFmncTtySup1NTooltype_a.html";
};

function regularize() {
// IP regularize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncTtySup1NTooltype", "srefIxFmncVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppFmncTtySup1NTooltype", "srefIxFmncVExpstate", "regd");

// IP regularize.estapp --- END
	getRecwnd().changeHeight("Sup1NTooltype", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Sup1NTooltype_side").setAttribute("height", "255");
	doc.getElementById("Sup1NTooltype_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Sup1NTooltype_side").src = "./PnlFmncTtySup1NTooltype_bside.html";
	doc.getElementById("Sup1NTooltype_cont").src = "./PnlFmncTtySup1NTooltype_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Sup1NTooltype_side").contentDocument;
	contdoc = doc.getElementById("Sup1NTooltype_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initB() {
	...
	sidedoc = doc.getElementById("Sup1NTooltype_side").contentDocument;
	contdoc = doc.getElementById("Sup1NTooltype_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Sup1NTooltype_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Sup1NTooltype_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Sup1NTooltype_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncTtySup1NTooltype", "Cpt"));

	// column headers in refreshB() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagFmncTtySup1NTooltype", "Trs"));
...
// IP init.estapp --- BEGIN
	var srefIxFmncVExpstate = retrieveSi(srcdoc, "StatAppFmncTtySup1NTooltype", "srefIxFmncVExpstate");
// IP init.estapp --- END
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncTtySup1NTooltype", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryFmncTtySup1NTooltype", "ntot") + ")");
};

function refreshB(chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryFmncTtySup1NTooltype", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncTtySup1NTooltype", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncTtySup1NTooltype", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryFmncTtySup1NTooltype", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacFmncTtySup1NTooltype", "TcoRefWidth"));
		...
		for (i=0;i<doc.cols.length;i++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagFmncTtySup1NTooltype", doc.cols[i]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (i=1;i<=ndisp;i++) {
		...
		// find element in ListFmncQTtySup1NTooltype
		rownode = getRownode(srcdoc, "ListFmncQTtySup1NTooltype", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagFmncTtySup1NTooltype", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagFmncTtySup1NTooltype", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfFmncTtySup1NTooltype", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Sup1NTooltype", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NTooltype_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NTooltype_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Sup1NTooltype_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Sup1NTooltype_src").contentDocument;
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncTtySup1NTooltype", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncTtySup1NTooltype", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryFmncTtySup1NTooltype", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryFmncTtySup1NTooltype", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppFmncTtySup1NTooltypeData", scrJref, "StgIacQryFmncTtySup1NTooltype");
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "firstcol"));

	setSi(srcdoc, "StatAppQryFmncTtySup1NTooltype", "firstcol", "" + (oldFirstcol-1));
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncTtySup1NTooltype", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppFmncTtySup1NTooltypeDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "ContInfFmncTtySup1NTooltype", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "StatAppFmncTtySup1NTooltype", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "StatShrFmncTtySup1NTooltype", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "StgIacFmncTtySup1NTooltype", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "TagFmncTtySup1NTooltype", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "ListFmncQTtySup1NTooltype", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "StatAppQryFmncTtySup1NTooltype", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "StatShrQryFmncTtySup1NTooltype", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngFmncTtySup1NTooltypeData", "StgIacQryFmncTtySup1NTooltype", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngFmncTtySup1NTooltypeData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngFmncTtySup1NTooltypeData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Sup1NTooltype");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngFmncTtySup1NTooltypeData") {
