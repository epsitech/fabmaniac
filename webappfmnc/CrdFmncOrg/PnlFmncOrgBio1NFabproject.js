/**
  * \file PnlFmncOrgBio1NFabproject.js
  * web client functionality for panel PnlFmncOrgBio1NFabproject
...
// IP minimize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncOrgBio1NFabproject", "srefIxFmncVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppFmncOrgBio1NFabproject", "srefIxFmncVExpstate", "mind");

// IP minimize.estapp --- END
	getRecwnd().changeHeight("Bio1NFabproject", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Bio1NFabproject_side").setAttribute("height", "30");
	doc.getElementById("Bio1NFabproject_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Bio1NFabproject_side").src = "./PnlFmncOrgBio1NFabproject_aside.html";
	doc.getElementById("Bio1NFabproject_cont").src = "./PnlFmncOrgBio1NFabproject_a.html";
};

function regularize() {
// IP regularize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncOrgBio1NFabproject", "srefIxFmncVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppFmncOrgBio1NFabproject", "srefIxFmncVExpstate", "regd");

// IP regularize.estapp --- END
	getRecwnd().changeHeight("Bio1NFabproject", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Bio1NFabproject_side").setAttribute("height", "255");
	doc.getElementById("Bio1NFabproject_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Bio1NFabproject_side").src = "./PnlFmncOrgBio1NFabproject_bside.html";
	doc.getElementById("Bio1NFabproject_cont").src = "./PnlFmncOrgBio1NFabproject_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Bio1NFabproject_side").contentDocument;
	contdoc = doc.getElementById("Bio1NFabproject_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initB() {
	...
	sidedoc = doc.getElementById("Bio1NFabproject_side").contentDocument;
	contdoc = doc.getElementById("Bio1NFabproject_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Bio1NFabproject_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Bio1NFabproject_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Bio1NFabproject_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncOrgBio1NFabproject", "Cpt"));

	// column headers in refreshB() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagFmncOrgBio1NFabproject", "Trs"));
...
// IP init.estapp --- BEGIN
	var srefIxFmncVExpstate = retrieveSi(srcdoc, "StatAppFmncOrgBio1NFabproject", "srefIxFmncVExpstate");
// IP init.estapp --- END
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncOrgBio1NFabproject", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryFmncOrgBio1NFabproject", "ntot") + ")");
};

function refreshB(chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgBio1NFabproject", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgBio1NFabproject", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgBio1NFabproject", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgBio1NFabproject", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacFmncOrgBio1NFabproject", "TcoRefWidth"));
		...
		for (i=0;i<doc.cols.length;i++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagFmncOrgBio1NFabproject", doc.cols[i]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (i=1;i<=ndisp;i++) {
		...
		// find element in ListFmncQOrgBio1NFabproject
		rownode = getRownode(srcdoc, "ListFmncQOrgBio1NFabproject", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagFmncOrgBio1NFabproject", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagFmncOrgBio1NFabproject", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfFmncOrgBio1NFabproject", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Bio1NFabproject", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Bio1NFabproject_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Bio1NFabproject_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Bio1NFabproject_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Bio1NFabproject_src").contentDocument;
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgBio1NFabproject", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgBio1NFabproject", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryFmncOrgBio1NFabproject", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryFmncOrgBio1NFabproject", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppFmncOrgBio1NFabprojectData", scrJref, "StgIacQryFmncOrgBio1NFabproject");
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "firstcol"));

	setSi(srcdoc, "StatAppQryFmncOrgBio1NFabproject", "firstcol", "" + (oldFirstcol-1));
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgBio1NFabproject", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppFmncOrgBio1NFabprojectDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "ContInfFmncOrgBio1NFabproject", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "StatAppFmncOrgBio1NFabproject", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "StatShrFmncOrgBio1NFabproject", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "StgIacFmncOrgBio1NFabproject", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "TagFmncOrgBio1NFabproject", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "ListFmncQOrgBio1NFabproject", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "StatAppQryFmncOrgBio1NFabproject", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "StatShrQryFmncOrgBio1NFabproject", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngFmncOrgBio1NFabprojectData", "StgIacQryFmncOrgBio1NFabproject", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngFmncOrgBio1NFabprojectData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngFmncOrgBio1NFabprojectData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Bio1NFabproject");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngFmncOrgBio1NFabprojectData") {
