/**
  * \file PnlFmncOrgSpl1NPurchorder.js
  * web client functionality for panel PnlFmncOrgSpl1NPurchorder
...
// IP minimize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncOrgSpl1NPurchorder", "srefIxFmncVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppFmncOrgSpl1NPurchorder", "srefIxFmncVExpstate", "mind");

// IP minimize.estapp --- END
	getRecwnd().changeHeight("Spl1NPurchorder", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Spl1NPurchorder_side").setAttribute("height", "30");
	doc.getElementById("Spl1NPurchorder_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Spl1NPurchorder_side").src = "./PnlFmncOrgSpl1NPurchorder_aside.html";
	doc.getElementById("Spl1NPurchorder_cont").src = "./PnlFmncOrgSpl1NPurchorder_a.html";
};

function regularize() {
// IP regularize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncOrgSpl1NPurchorder", "srefIxFmncVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppFmncOrgSpl1NPurchorder", "srefIxFmncVExpstate", "regd");

// IP regularize.estapp --- END
	getRecwnd().changeHeight("Spl1NPurchorder", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Spl1NPurchorder_side").setAttribute("height", "255");
	doc.getElementById("Spl1NPurchorder_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Spl1NPurchorder_side").src = "./PnlFmncOrgSpl1NPurchorder_bside.html";
	doc.getElementById("Spl1NPurchorder_cont").src = "./PnlFmncOrgSpl1NPurchorder_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Spl1NPurchorder_side").contentDocument;
	contdoc = doc.getElementById("Spl1NPurchorder_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initB() {
	...
	sidedoc = doc.getElementById("Spl1NPurchorder_side").contentDocument;
	contdoc = doc.getElementById("Spl1NPurchorder_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Spl1NPurchorder_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Spl1NPurchorder_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Spl1NPurchorder_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncOrgSpl1NPurchorder", "Cpt"));

	// column headers in refreshB() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagFmncOrgSpl1NPurchorder", "Trs"));
...
// IP init.estapp --- BEGIN
	var srefIxFmncVExpstate = retrieveSi(srcdoc, "StatAppFmncOrgSpl1NPurchorder", "srefIxFmncVExpstate");
// IP init.estapp --- END
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncOrgSpl1NPurchorder", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryFmncOrgSpl1NPurchorder", "ntot") + ")");
};

function refreshB(chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgSpl1NPurchorder", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgSpl1NPurchorder", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgSpl1NPurchorder", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgSpl1NPurchorder", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacFmncOrgSpl1NPurchorder", "TcoRefWidth"));
		...
		for (i=0;i<doc.cols.length;i++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagFmncOrgSpl1NPurchorder", doc.cols[i]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (i=1;i<=ndisp;i++) {
		...
		// find element in ListFmncQOrgSpl1NPurchorder
		rownode = getRownode(srcdoc, "ListFmncQOrgSpl1NPurchorder", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagFmncOrgSpl1NPurchorder", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagFmncOrgSpl1NPurchorder", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfFmncOrgSpl1NPurchorder", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Spl1NPurchorder", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Spl1NPurchorder_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Spl1NPurchorder_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Spl1NPurchorder_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Spl1NPurchorder_src").contentDocument;
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgSpl1NPurchorder", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgSpl1NPurchorder", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryFmncOrgSpl1NPurchorder", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryFmncOrgSpl1NPurchorder", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppFmncOrgSpl1NPurchorderData", scrJref, "StgIacQryFmncOrgSpl1NPurchorder");
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "firstcol"));

	setSi(srcdoc, "StatAppQryFmncOrgSpl1NPurchorder", "firstcol", "" + (oldFirstcol-1));
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgSpl1NPurchorder", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppFmncOrgSpl1NPurchorderDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "ContInfFmncOrgSpl1NPurchorder", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "StatAppFmncOrgSpl1NPurchorder", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "StatShrFmncOrgSpl1NPurchorder", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "StgIacFmncOrgSpl1NPurchorder", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "TagFmncOrgSpl1NPurchorder", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "ListFmncQOrgSpl1NPurchorder", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "StatAppQryFmncOrgSpl1NPurchorder", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "StatShrQryFmncOrgSpl1NPurchorder", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngFmncOrgSpl1NPurchorderData", "StgIacQryFmncOrgSpl1NPurchorder", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngFmncOrgSpl1NPurchorderData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngFmncOrgSpl1NPurchorderData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Spl1NPurchorder");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngFmncOrgSpl1NPurchorderData") {
