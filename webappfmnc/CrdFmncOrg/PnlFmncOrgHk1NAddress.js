/**
  * \file PnlFmncOrgHk1NAddress.js
  * web client functionality for panel PnlFmncOrgHk1NAddress
...
// IP minimize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncOrgHk1NAddress", "srefIxFmncVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppFmncOrgHk1NAddress", "srefIxFmncVExpstate", "mind");

// IP minimize.estapp --- END
	getRecwnd().changeHeight("Hk1NAddress", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Hk1NAddress_side").setAttribute("height", "30");
	doc.getElementById("Hk1NAddress_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Hk1NAddress_side").src = "./PnlFmncOrgHk1NAddress_aside.html";
	doc.getElementById("Hk1NAddress_cont").src = "./PnlFmncOrgHk1NAddress_a.html";
};

function regularize() {
// IP regularize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncOrgHk1NAddress", "srefIxFmncVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppFmncOrgHk1NAddress", "srefIxFmncVExpstate", "regd");

// IP regularize.estapp --- END
	getRecwnd().changeHeight("Hk1NAddress", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Hk1NAddress_side").setAttribute("height", "255");
	doc.getElementById("Hk1NAddress_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Hk1NAddress_side").src = "./PnlFmncOrgHk1NAddress_bside.html";
	doc.getElementById("Hk1NAddress_cont").src = "./PnlFmncOrgHk1NAddress_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Hk1NAddress_side").contentDocument;
	contdoc = doc.getElementById("Hk1NAddress_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initB() {
	...
	sidedoc = doc.getElementById("Hk1NAddress_side").contentDocument;
	contdoc = doc.getElementById("Hk1NAddress_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Hk1NAddress_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Hk1NAddress_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Hk1NAddress_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncOrgHk1NAddress", "Cpt"));

	// column headers in refreshB() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagFmncOrgHk1NAddress", "Trs"));
...
// IP init.estapp --- BEGIN
	var srefIxFmncVExpstate = retrieveSi(srcdoc, "StatAppFmncOrgHk1NAddress", "srefIxFmncVExpstate");
// IP init.estapp --- END
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncOrgHk1NAddress", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryFmncOrgHk1NAddress", "ntot") + ")");
};

function refreshB(chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgHk1NAddress", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgHk1NAddress", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgHk1NAddress", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgHk1NAddress", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacFmncOrgHk1NAddress", "TcoRefWidth"));
		...
		for (i=0;i<doc.cols.length;i++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagFmncOrgHk1NAddress", doc.cols[i]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (i=1;i<=ndisp;i++) {
		...
		// find element in ListFmncQOrgHk1NAddress
		rownode = getRownode(srcdoc, "ListFmncQOrgHk1NAddress", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagFmncOrgHk1NAddress", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagFmncOrgHk1NAddress", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfFmncOrgHk1NAddress", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Hk1NAddress", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Hk1NAddress_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Hk1NAddress_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Hk1NAddress_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Hk1NAddress_src").contentDocument;
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgHk1NAddress", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncOrgHk1NAddress", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryFmncOrgHk1NAddress", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryFmncOrgHk1NAddress", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppFmncOrgHk1NAddressData", scrJref, "StgIacQryFmncOrgHk1NAddress");
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "firstcol"));

	setSi(srcdoc, "StatAppQryFmncOrgHk1NAddress", "firstcol", "" + (oldFirstcol-1));
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncOrgHk1NAddress", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppFmncOrgHk1NAddressDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "ContInfFmncOrgHk1NAddress", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "StatAppFmncOrgHk1NAddress", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "StatShrFmncOrgHk1NAddress", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "StgIacFmncOrgHk1NAddress", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "TagFmncOrgHk1NAddress", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "ListFmncQOrgHk1NAddress", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "StatAppQryFmncOrgHk1NAddress", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "StatShrQryFmncOrgHk1NAddress", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngFmncOrgHk1NAddressData", "StgIacQryFmncOrgHk1NAddress", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngFmncOrgHk1NAddressData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngFmncOrgHk1NAddressData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Hk1NAddress");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngFmncOrgHk1NAddressData") {
