/**
  * \file PnlFmncSmpSup1NSample.js
  * web client functionality for panel PnlFmncSmpSup1NSample
...
// IP minimize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncSmpSup1NSample", "srefIxFmncVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppFmncSmpSup1NSample", "srefIxFmncVExpstate", "mind");

// IP minimize.estapp --- END
	getRecwnd().changeHeight("Sup1NSample", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Sup1NSample_side").setAttribute("height", "30");
	doc.getElementById("Sup1NSample_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Sup1NSample_side").src = "./PnlFmncSmpSup1NSample_aside.html";
	doc.getElementById("Sup1NSample_cont").src = "./PnlFmncSmpSup1NSample_a.html";
};

function regularize() {
// IP regularize.estapp --- BEGIN
	if (retrieveSi(srcdoc, "StatAppFmncSmpSup1NSample", "srefIxFmncVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppFmncSmpSup1NSample", "srefIxFmncVExpstate", "regd");

// IP regularize.estapp --- END
	getRecwnd().changeHeight("Sup1NSample", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Sup1NSample_side").setAttribute("height", "255");
	doc.getElementById("Sup1NSample_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Sup1NSample_side").src = "./PnlFmncSmpSup1NSample_bside.html";
	doc.getElementById("Sup1NSample_cont").src = "./PnlFmncSmpSup1NSample_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Sup1NSample_side").contentDocument;
	contdoc = doc.getElementById("Sup1NSample_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initB() {
	...
	sidedoc = doc.getElementById("Sup1NSample_side").contentDocument;
	contdoc = doc.getElementById("Sup1NSample_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Sup1NSample_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Sup1NSample_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Sup1NSample_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncSmpSup1NSample", "Cpt"));

	// column headers in refreshB() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagFmncSmpSup1NSample", "Trs"));
...
// IP init.estapp --- BEGIN
	var srefIxFmncVExpstate = retrieveSi(srcdoc, "StatAppFmncSmpSup1NSample", "srefIxFmncVExpstate");
// IP init.estapp --- END
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagFmncSmpSup1NSample", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryFmncSmpSup1NSample", "ntot") + ")");
};

function refreshB(chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryFmncSmpSup1NSample", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncSmpSup1NSample", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncSmpSup1NSample", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryFmncSmpSup1NSample", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacFmncSmpSup1NSample", "TcoRefWidth"));
		...
		for (i=0;i<doc.cols.length;i++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagFmncSmpSup1NSample", doc.cols[i]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (i=1;i<=ndisp;i++) {
		...
		// find element in ListFmncQSmpSup1NSample
		rownode = getRownode(srcdoc, "ListFmncQSmpSup1NSample", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagFmncSmpSup1NSample", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagFmncSmpSup1NSample", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfFmncSmpSup1NSample", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Sup1NSample", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NSample_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NSample_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Sup1NSample_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Sup1NSample_src").contentDocument;
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncSmpSup1NSample", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryFmncSmpSup1NSample", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryFmncSmpSup1NSample", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryFmncSmpSup1NSample", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppFmncSmpSup1NSampleData", scrJref, "StgIacQryFmncSmpSup1NSample");
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "firstcol"));

	setSi(srcdoc, "StatAppQryFmncSmpSup1NSample", "firstcol", "" + (oldFirstcol-1));
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryFmncSmpSup1NSample", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppFmncSmpSup1NSampleDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "ContInfFmncSmpSup1NSample", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "StatAppFmncSmpSup1NSample", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "StatShrFmncSmpSup1NSample", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "StgIacFmncSmpSup1NSample", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "TagFmncSmpSup1NSample", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "ListFmncQSmpSup1NSample", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "StatAppQryFmncSmpSup1NSample", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "StatShrQryFmncSmpSup1NSample", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngFmncSmpSup1NSampleData", "StgIacQryFmncSmpSup1NSample", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngFmncSmpSup1NSampleData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngFmncSmpSup1NSampleData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Sup1NSample");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngFmncSmpSup1NSampleData") {
