/**
  ...
  * job handler for job PnlFmncPrjDetail (declarations)
...
/**
  * PnlFmncPrjDetail
  */
class PnlFmncPrjDetail : public JobFmnc {
...
// IP constructor --- BEGIN
	PnlFmncPrjDetail(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncPrjDetail();
...
public:
	...
	void refreshRecPrj(DbsFmnc* dbsfmnc, set<uint>& moditems);
	void refreshRecPrjJste(DbsFmnc* dbsfmnc, set<uint>& moditems);
...
// IP handleCall --- END
	...
	bool handleCallFmncPrjJsteMod_prjEq(DbsFmnc* dbsfmnc, const ubigint jrefTrig, const ubigint refInv);
};
