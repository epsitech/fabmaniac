/**
  * \file PnlFmncPrjList.h
  * job handler for job PnlFmncPrjList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCPRJLIST_H
#define PNLFMNCPRJLIST_H
...
/**
  * PnlFmncPrjList
  */
class PnlFmncPrjList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncPrjListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncPrjList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncPrjList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncPrjList)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncPrjListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncPrjListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncPrjListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQPrjList* rst = NULL, QryFmncPrjList::StatShr* statshrqry = NULL, QryFmncPrjList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncPrjList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncPrjList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncPrjList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
