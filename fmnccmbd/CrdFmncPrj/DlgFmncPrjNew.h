/**
  ...
  * job handler for job DlgFmncPrjNew (declarations)
...
/**
  * DlgFmncPrjNew
  */
class DlgFmncPrjNew : public JobFmnc {
...
// IP constructor --- BEGIN
	DlgFmncPrjNew(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~DlgFmncPrjNew();
