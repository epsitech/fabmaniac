/**
  ...
  * job handler for job PnlFmncSkiList (declarations)
...
/**
  * PnlFmncSkiList
  */
class PnlFmncSkiList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSkiList* rst = NULL, QryFmncSkiList::StatShr* statshrqry = NULL, QryFmncSkiList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncSkiList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSkiList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSkiList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
