/**
  * \file QryFmncSkiList.h
  * job handler for job QryFmncSkiList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCSKILIST_H
#define QRYFMNCSKILIST_H
...
/**
  * QryFmncSkiList
  */
class QryFmncSkiList : public JobFmnc {

public:
	/**
		* VecVOrd (full: VecVQryFmncSkiListOrd)
		*/
	class VecVOrd {

	public:
		static const uint ORG = 1;
		static const uint ART = 2;
	...
	/**
		* StatApp (full: StatAppQryFmncSkiList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncSkiList)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncSkiList)
		*/
...
// IP constructor --- BEGIN
	QryFmncSkiList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncSkiList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const ubigint preOrg, const ubigint preArt, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallFmncSkiMod(DbsFmnc* dbsfmnc, const ubigint jrefTrig);
