/**
  * \file PnlFmncTtyList.h
  * job handler for job PnlFmncTtyList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCTTYLIST_H
#define PNLFMNCTTYLIST_H
...
/**
  * PnlFmncTtyList
  */
class PnlFmncTtyList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncTtyListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncTtyList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncTtyList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncTtyList)
		*/
	...
	public:
		StgIac(const uint TcoSrfWidth = 100, const uint TcoTitWidth = 100, const uint TcoSupWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppFmncTtyListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncTtyListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncTtyListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQTtyList* rst = NULL, QryFmncTtyList::StatShr* statshrqry = NULL, QryFmncTtyList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTtyList::StatShr statshrqry;
		QryFmncTtyList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncTtyList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncTtyList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncTtyList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
