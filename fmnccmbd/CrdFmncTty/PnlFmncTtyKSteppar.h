/**
  * \file PnlFmncTtyKSteppar.h
  * job handler for job PnlFmncTtyKSteppar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCTTYKSTEPPAR_H
#define PNLFMNCTTYKSTEPPAR_H
...
/**
  * PnlFmncTtyKSteppar
  */
class PnlFmncTtyKSteppar : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncTtyKStepparDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncTtyKSteppar)
	  */
	...
	/**
		* StatApp (full: StatAppFmncTtyKSteppar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncTtyKSteppar)
		*/
	...
	/**
		* StgIac (full: StgIacFmncTtyKSteppar)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncTtyKStepparData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncTtyKStepparDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncTtyKStepparData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQTtyKSteppar* rst = NULL, QryFmncTtyKSteppar::StatShr* statshrqry = NULL, QryFmncTtyKSteppar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncTtyKSteppar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncTtyKSteppar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncTtyKSteppar::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
