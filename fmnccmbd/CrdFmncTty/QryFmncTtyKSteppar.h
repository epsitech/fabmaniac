/**
  * \file QryFmncTtyKSteppar.h
  * job handler for job QryFmncTtyKSteppar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCTTYKSTEPPAR_H
#define QRYFMNCTTYKSTEPPAR_H
...
/**
  * QryFmncTtyKSteppar
  */
class QryFmncTtyKSteppar : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncTtyKSteppar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncTtyKSteppar)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncTtyKSteppar)
		*/
...
// IP constructor --- BEGIN
	QryFmncTtyKSteppar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncTtyKSteppar();
