/**
  * \file PnlFmncRunMNSample.h
  * job handler for job PnlFmncRunMNSample (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCRUNMNSAMPLE_H
#define PNLFMNCRUNMNSAMPLE_H
...
/**
  * PnlFmncRunMNSample
  */
class PnlFmncRunMNSample : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncRunMNSampleDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncRunMNSample)
	  */
	...
	/**
		* StatApp (full: StatAppFmncRunMNSample)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncRunMNSample)
		*/
	...
	/**
		* StgIac (full: StgIacFmncRunMNSample)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncRunMNSampleData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncRunMNSample::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncRunMNSampleDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncRunMNSampleData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQRunMNSample* rst = NULL, QryFmncRunMNSample::StatShr* statshrqry = NULL, QryFmncRunMNSample::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncRunMNSample::StatShr statshrqry;
		QryFmncRunMNSample::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncRunMNSample(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncRunMNSample();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncRunMNSample::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
