/**
  * \file CrdFmncRun.h
  * job handler for job CrdFmncRun (declarations)
...
/**
  * CrdFmncRun
  */
class CrdFmncRun : public JobFmnc {
...
public:
	CrdFmncRun(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncRun();
...
public:
	...
	DlgFmncRunGenrep* dlggenrep;
	DlgFmncRunNew* dlgnew;
	PnlFmncRunRec* pnlrec;
	PnlFmncRunHeadbar* pnlheadbar;
	PnlFmncRunList* pnllist;
