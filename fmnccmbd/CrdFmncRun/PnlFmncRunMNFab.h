/**
  * \file PnlFmncRunMNFab.h
  * job handler for job PnlFmncRunMNFab (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCRUNMNFAB_H
#define PNLFMNCRUNMNFAB_H
...
/**
  * PnlFmncRunMNFab
  */
class PnlFmncRunMNFab : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncRunMNFabDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncRunMNFab)
	  */
	...
	/**
		* StatApp (full: StatAppFmncRunMNFab)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncRunMNFab)
		*/
	...
	/**
		* StgIac (full: StgIacFmncRunMNFab)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncRunMNFabData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncRunMNFabDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncRunMNFabData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQRunMNFab* rst = NULL, QryFmncRunMNFab::StatShr* statshrqry = NULL, QryFmncRunMNFab::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncRunMNFab::StatShr statshrqry;
		QryFmncRunMNFab::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncRunMNFab(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncRunMNFab();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncRunMNFab::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
