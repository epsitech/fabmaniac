/**
  * \file QryFmncRunRun1NActivity_blks.cpp
  * job handler for job QryFmncRunRun1NActivity (implementation of blocks)
...
void QryFmncRunRun1NActivity::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryFmncRunRun1NActivity";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppQryFmncRunRun1NActivity";
...
void QryFmncRunRun1NActivity::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrQryFmncRunRun1NActivity";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryFmncRunRun1NActivity";
