/**
  * \file PnlFmncTol1NArticle.cpp
  * job handler for job PnlFmncTol1NArticle (implementation)
...
#include "PnlFmncTol1NArticle_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "PnlFmncTol1NArticle_evals.cpp"
// IP evalsInclude --- END

/******************************************************************************
 class PnlFmncTol1NArticle
 ******************************************************************************/

// IP constructor.hdr --- BEGIN
PnlFmncTol1NArticle::PnlFmncTol1NArticle(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::PNLFMNCTOL1NARTICLE, jrefSup, ixFmncVLocale) {
...
// IP constructor.cust1 --- INSERT
	...
	qry = new QryFmncTol1NArticle(xchg, dbsfmnc, jref, ixFmncVLocale);
...
// IP cust --- INSERT
DpchEngFmnc* PnlFmncTol1NArticle::getNewDpchEng(
			set<uint> items
		) {
...
void PnlFmncTol1NArticle::refresh(
			DbsFmnc* dbsfmnc
			, set<uint>& moditems
		) {
...
void PnlFmncTol1NArticle::updatePreset(
			DbsFmnc* dbsfmnc
...
void PnlFmncTol1NArticle::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCTOL1NARTICLEDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCTOL1NARTICLEDO) {
...
void PnlFmncTol1NArticle::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void PnlFmncTol1NArticle::handleDpchAppDataStgiac(
			DbsFmnc* dbsfmnc
			, StgIac* _stgiac
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncTol1NArticle::handleDpchAppDataStgiacqry(
			DbsFmnc* dbsfmnc
			, QryFmncTol1NArticle::StgIac* _stgiacqry
			, DpchEngFmnc** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryFmncTol1NArticle::StgIac::JNUM)) refSelNew = qry->getRefByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryFmncTol1NArticle::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->refresh(dbsfmnc);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryFmncTol1NArticle::StgIac::JNUM)) {
...
void PnlFmncTol1NArticle::handleDpchAppDoButViewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint refSel;
...
void PnlFmncTol1NArticle::handleDpchAppDoButNewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlFmncTol1NArticle::handleDpchAppDoButDeleteClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncTol1NArticle::handleDpchAppDoButRefreshClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	set<uint> moditems;
...
void PnlFmncTol1NArticle::handleCall(
			DbsFmnc* dbsfmnc
			, Call* call
		) {
...
bool PnlFmncTol1NArticle::handleCallFmncStatChg(
			DbsFmnc* dbsfmnc
			, const ubigint jrefTrig
		) {
	bool retval = false;
