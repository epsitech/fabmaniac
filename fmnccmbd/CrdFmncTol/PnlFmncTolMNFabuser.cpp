/**
  * \file PnlFmncTolMNFabuser.cpp
  * job handler for job PnlFmncTolMNFabuser (implementation)
...
#include "PnlFmncTolMNFabuser_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "PnlFmncTolMNFabuser_evals.cpp"
// IP evalsInclude --- END

/******************************************************************************
 class PnlFmncTolMNFabuser
 ******************************************************************************/

// IP constructor.hdr --- BEGIN
PnlFmncTolMNFabuser::PnlFmncTolMNFabuser(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::PNLFMNCTOLMNFABUSER, jrefSup, ixFmncVLocale) {
...
// IP constructor.cust1 --- INSERT
	...
	qry = new QryFmncTolMNFabuser(xchg, dbsfmnc, jref, ixFmncVLocale);
...
// IP cust --- INSERT
DpchEngFmnc* PnlFmncTolMNFabuser::getNewDpchEng(
			set<uint> items
		) {
...
void PnlFmncTolMNFabuser::refresh(
			DbsFmnc* dbsfmnc
			, set<uint>& moditems
		) {
...
void PnlFmncTolMNFabuser::updatePreset(
			DbsFmnc* dbsfmnc
...
void PnlFmncTolMNFabuser::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCTOLMNFABUSERDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCTOLMNFABUSERDO) {
...
void PnlFmncTolMNFabuser::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void PnlFmncTolMNFabuser::handleDpchAppDataStgiac(
			DbsFmnc* dbsfmnc
			, StgIac* _stgiac
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncTolMNFabuser::handleDpchAppDataStgiacqry(
			DbsFmnc* dbsfmnc
			, QryFmncTolMNFabuser::StgIac* _stgiacqry
			, DpchEngFmnc** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryFmncTolMNFabuser::StgIac::JNUM)) refSelNew = qry->getRefByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryFmncTolMNFabuser::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->refresh(dbsfmnc);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryFmncTolMNFabuser::StgIac::JNUM)) {
...
void PnlFmncTolMNFabuser::handleDpchAppDoButViewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint refSel;
	...
	if (dbsfmnc->loadUbigintBySQL("SELECT mref FROM TblFmncQTolMNFabuser WHERE ref = " + to_string(refSel), refSel)) {
...
void PnlFmncTolMNFabuser::handleDpchAppDoButAddClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncTolMNFabuser::handleDpchAppDoButSubClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncTolMNFabuser::handleDpchAppDoButRefreshClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	set<uint> moditems;
...
void PnlFmncTolMNFabuser::handleCall(
			DbsFmnc* dbsfmnc
			, Call* call
		) {
...
bool PnlFmncTolMNFabuser::handleCallFmncStatChg(
			DbsFmnc* dbsfmnc
			, const ubigint jrefTrig
		) {
	bool retval = false;
