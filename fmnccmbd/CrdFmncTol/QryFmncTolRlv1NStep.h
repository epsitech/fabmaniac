/**
  ...
  * job handler for job QryFmncTolRlv1NStep (declarations)
...
/**
  * QryFmncTolRlv1NStep
  */
class QryFmncTolRlv1NStep : public JobFmnc {
...
// IP constructor --- BEGIN
	QryFmncTolRlv1NStep(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncTolRlv1NStep();
