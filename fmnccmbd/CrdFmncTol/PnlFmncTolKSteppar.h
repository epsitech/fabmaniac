/**
  * \file PnlFmncTolKSteppar.h
  * job handler for job PnlFmncTolKSteppar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCTOLKSTEPPAR_H
#define PNLFMNCTOLKSTEPPAR_H
...
/**
  * PnlFmncTolKSteppar
  */
class PnlFmncTolKSteppar : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncTolKStepparDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncTolKSteppar)
	  */
	...
	/**
		* StatApp (full: StatAppFmncTolKSteppar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncTolKSteppar)
		*/
	...
	/**
		* StgIac (full: StgIacFmncTolKSteppar)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncTolKStepparData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncTolKStepparDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncTolKStepparData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQTolKSteppar* rst = NULL, QryFmncTolKSteppar::StatShr* statshrqry = NULL, QryFmncTolKSteppar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncTolKSteppar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncTolKSteppar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncTolKSteppar::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
