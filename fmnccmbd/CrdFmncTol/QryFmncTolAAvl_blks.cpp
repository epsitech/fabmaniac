/**
  * \file QryFmncTolAAvl_blks.cpp
  * job handler for job QryFmncTolAAvl (implementation of blocks)
...
void QryFmncTolAAvl::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryFmncTolAAvl";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppQryFmncTolAAvl";
...
void QryFmncTolAAvl::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrQryFmncTolAAvl";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryFmncTolAAvl";
