/**
  * \file PnlFmncTolList.h
  * job handler for job PnlFmncTolList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCTOLLIST_H
#define PNLFMNCTOLLIST_H
...
/**
  * PnlFmncTolList
  */
class PnlFmncTolList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncTolListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncTolList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncTolList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncTolList)
		*/
	...
	/**
		* StgIac (full: StgIacFmncTolList)
		*/
	class StgIac : public Block {

	public:
		static const uint TCOTITWIDTH = 1;
		static const uint TCOFABWIDTH = 2;
		static const uint TCOMNFWIDTH = 3;
		static const uint TCOUPRWIDTH = 4;
		static const uint TCOTRNWIDTH = 5;

	public:
		StgIac(const uint TcoTitWidth = 100, const uint TcoFabWidth = 100, const uint TcoMnfWidth = 100, const uint TcoUprWidth = 100, const uint TcoTrnWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppFmncTolListData)
		*/
	...
	public:
		ContIac contiac;
		StgIac stgiac;
		QryFmncTolList::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncTolListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncTolListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQTolList* rst = NULL, QryFmncTolList::StatShr* statshrqry = NULL, QryFmncTolList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncTolList::StatShr statshrqry;
		QryFmncTolList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncTolList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncTolList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncTolList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
