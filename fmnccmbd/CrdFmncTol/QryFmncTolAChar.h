/**
  * \file QryFmncTolAChar.h
  * job handler for job QryFmncTolAChar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCTOLACHAR_H
#define QRYFMNCTOLACHAR_H
...
/**
  * QryFmncTolAChar
  */
class QryFmncTolAChar : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncTolAChar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncTolAChar)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncTolAChar)
		*/
...
// IP constructor --- BEGIN
	QryFmncTolAChar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncTolAChar();
...
// IP handleCall --- END
	...
	bool handleCallFmncTolAchaMod_tolEq(DbsFmnc* dbsfmnc, const ubigint jrefTrig, const ubigint refInv);
};
