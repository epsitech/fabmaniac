/**
  * \file PnlFmncTolKToolchar.h
  * job handler for job PnlFmncTolKToolchar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCTOLKTOOLCHAR_H
#define PNLFMNCTOLKTOOLCHAR_H
...
/**
  * PnlFmncTolKToolchar
  */
class PnlFmncTolKToolchar : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncTolKToolcharDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncTolKToolchar)
	  */
	...
	/**
		* StatApp (full: StatAppFmncTolKToolchar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncTolKToolchar)
		*/
	...
	/**
		* StgIac (full: StgIacFmncTolKToolchar)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncTolKToolcharData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncTolKToolcharDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncTolKToolcharData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQTolKToolchar* rst = NULL, QryFmncTolKToolchar::StatShr* statshrqry = NULL, QryFmncTolKToolchar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncTolKToolchar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncTolKToolchar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncTolKToolchar::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
