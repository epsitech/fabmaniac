/**
  * \file QryFmncTolKToolchar_blks.cpp
  * job handler for job QryFmncTolKToolchar (implementation of blocks)
...
void QryFmncTolKToolchar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryFmncTolKToolchar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppQryFmncTolKToolchar";
...
void QryFmncTolKToolchar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrQryFmncTolKToolchar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryFmncTolKToolchar";
