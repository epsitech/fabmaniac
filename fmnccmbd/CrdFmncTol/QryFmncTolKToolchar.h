/**
  * \file QryFmncTolKToolchar.h
  * job handler for job QryFmncTolKToolchar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCTOLKTOOLCHAR_H
#define QRYFMNCTOLKTOOLCHAR_H
...
/**
  * QryFmncTolKToolchar
  */
class QryFmncTolKToolchar : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncTolKToolchar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncTolKToolchar)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncTolKToolchar)
		*/
...
// IP constructor --- BEGIN
	QryFmncTolKToolchar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncTolKToolchar();
