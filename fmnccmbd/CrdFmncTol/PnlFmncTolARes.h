/**
  ...
  * job handler for job PnlFmncTolARes (declarations)
...
/**
  * PnlFmncTolARes
  */
class PnlFmncTolARes : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQTolARes* rst = NULL, QryFmncTolARes::StatShr* statshrqry = NULL, QryFmncTolARes::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncTolARes(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncTolARes();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncTolARes::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
