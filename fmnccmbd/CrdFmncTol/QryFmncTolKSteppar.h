/**
  ...
  * job handler for job QryFmncTolKSteppar (declarations)
...
/**
  * QryFmncTolKSteppar
  */
class QryFmncTolKSteppar : public JobFmnc {
...
// IP constructor --- BEGIN
	QryFmncTolKSteppar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncTolKSteppar();
