/**
  * \file PnlFmncSepRef1NFile.h
  * job handler for job PnlFmncSepRef1NFile (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSEPREF1NFILE_H
#define PNLFMNCSEPREF1NFILE_H
...
/**
  * PnlFmncSepRef1NFile
  */
class PnlFmncSepRef1NFile : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncSepRef1NFileDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncSepRef1NFile)
	  */
	...
	/**
		* StatApp (full: StatAppFmncSepRef1NFile)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncSepRef1NFile)
		*/
	...
	/**
		* StgIac (full: StgIacFmncSepRef1NFile)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncSepRef1NFileData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncSepRef1NFile::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncSepRef1NFileDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncSepRef1NFileData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSepRef1NFile* rst = NULL, QryFmncSepRef1NFile::StatShr* statshrqry = NULL, QryFmncSepRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSepRef1NFile::StatShr statshrqry;
		QryFmncSepRef1NFile::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncSepRef1NFile(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSepRef1NFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSepRef1NFile::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
