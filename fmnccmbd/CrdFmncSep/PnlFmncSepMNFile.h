/**
  * \file PnlFmncSepMNFile.h
  * job handler for job PnlFmncSepMNFile (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSEPMNFILE_H
#define PNLFMNCSEPMNFILE_H
...
/**
  * PnlFmncSepMNFile
  */
class PnlFmncSepMNFile : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncSepMNFileDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncSepMNFile)
	  */
	...
	/**
		* StatApp (full: StatAppFmncSepMNFile)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncSepMNFile)
		*/
	...
	/**
		* StgIac (full: StgIacFmncSepMNFile)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncSepMNFileData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncSepMNFileDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncSepMNFileData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSepMNFile* rst = NULL, QryFmncSepMNFile::StatShr* statshrqry = NULL, QryFmncSepMNFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSepMNFile::StatShr statshrqry;
		QryFmncSepMNFile::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncSepMNFile(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSepMNFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSepMNFile::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
