/**
  * \file CrdFmncSep.h
  * job handler for job CrdFmncSep (declarations)
...
/**
  * CrdFmncSep
  */
class CrdFmncSep : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncSepDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDSEP = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdSep = "");
	...
	/**
		* DpchAppDo (full: DpchAppFmncSepDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncSepData)
		*/
...
public:
	CrdFmncSep(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0, const uint ixFmncVPreset = VecFmncVPreset::VOID, const ubigint preUref = 0);
	~CrdFmncSep();
...
public:
	...
	PnlFmncSepRec* pnlrec;
	PnlFmncSepHeadbar* pnlheadbar;
	PnlFmncSepList* pnllist;
