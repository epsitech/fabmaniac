/**
  ...
  * job handler for job PnlFmncSepDetail (declarations)
...
/**
  * PnlFmncSepDetail
  */
class PnlFmncSepDetail : public JobFmnc {
...
// IP constructor --- BEGIN
	PnlFmncSepDetail(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSepDetail();
