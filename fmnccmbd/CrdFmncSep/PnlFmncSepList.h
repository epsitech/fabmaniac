/**
  ...
  * job handler for job PnlFmncSepList (declarations)
...
/**
  * PnlFmncSepList
  */
class PnlFmncSepList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSepList* rst = NULL, QryFmncSepList::StatShr* statshrqry = NULL, QryFmncSepList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncSepList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSepList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSepList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
