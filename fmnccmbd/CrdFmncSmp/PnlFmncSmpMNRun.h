/**
  ...
  * job handler for job PnlFmncSmpMNRun (declarations)
...
/**
  * PnlFmncSmpMNRun
  */
class PnlFmncSmpMNRun : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSmpMNRun* rst = NULL, QryFmncSmpMNRun::StatShr* statshrqry = NULL, QryFmncSmpMNRun::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncSmpMNRun(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSmpMNRun();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSmpMNRun::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
