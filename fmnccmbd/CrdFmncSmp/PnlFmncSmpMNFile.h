/**
  * \file PnlFmncSmpMNFile.h
  * job handler for job PnlFmncSmpMNFile (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSMPMNFILE_H
#define PNLFMNCSMPMNFILE_H
...
/**
  * PnlFmncSmpMNFile
  */
class PnlFmncSmpMNFile : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncSmpMNFileDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncSmpMNFile)
	  */
	...
	/**
		* StatApp (full: StatAppFmncSmpMNFile)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncSmpMNFile)
		*/
	...
	/**
		* StgIac (full: StgIacFmncSmpMNFile)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncSmpMNFileData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncSmpMNFile::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncSmpMNFileDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncSmpMNFileData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSmpMNFile* rst = NULL, QryFmncSmpMNFile::StatShr* statshrqry = NULL, QryFmncSmpMNFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSmpMNFile::StatShr statshrqry;
		QryFmncSmpMNFile::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncSmpMNFile(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSmpMNFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSmpMNFile::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
