/**
  ...
  * job handler for job QryFmncSmpList (declarations)
...
/**
  * QryFmncSmpList
  */
class QryFmncSmpList : public JobFmnc {
...
// IP constructor --- BEGIN
	QryFmncSmpList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncSmpList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preSrf, const ubigint preSup, const ubigint preArt, const uint preSte, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallFmncSmpMod(DbsFmnc* dbsfmnc, const ubigint jrefTrig);
