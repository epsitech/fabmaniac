/**
  * \file PnlFmncSmpRef1NFile.cpp
  * job handler for job PnlFmncSmpRef1NFile (implementation)
...
#include "PnlFmncSmpRef1NFile_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "PnlFmncSmpRef1NFile_evals.cpp"
// IP evalsInclude --- END

/******************************************************************************
 class PnlFmncSmpRef1NFile
 ******************************************************************************/

// IP constructor.hdr --- BEGIN
PnlFmncSmpRef1NFile::PnlFmncSmpRef1NFile(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::PNLFMNCSMPREF1NFILE, jrefSup, ixFmncVLocale) {
...
// IP constructor.cust1 --- INSERT
	...
	qry = new QryFmncSmpRef1NFile(xchg, dbsfmnc, jref, ixFmncVLocale);
...
// IP cust --- INSERT
DpchEngFmnc* PnlFmncSmpRef1NFile::getNewDpchEng(
			set<uint> items
		) {
...
void PnlFmncSmpRef1NFile::refresh(
			DbsFmnc* dbsfmnc
			, set<uint>& moditems
		) {
...
void PnlFmncSmpRef1NFile::updatePreset(
			DbsFmnc* dbsfmnc
...
void PnlFmncSmpRef1NFile::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCSMPREF1NFILEDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCSMPREF1NFILEDO) {
...
void PnlFmncSmpRef1NFile::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void PnlFmncSmpRef1NFile::handleDpchAppDataStgiac(
			DbsFmnc* dbsfmnc
			, StgIac* _stgiac
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncSmpRef1NFile::handleDpchAppDataStgiacqry(
			DbsFmnc* dbsfmnc
			, QryFmncSmpRef1NFile::StgIac* _stgiacqry
			, DpchEngFmnc** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryFmncSmpRef1NFile::StgIac::JNUM)) refSelNew = qry->getRefByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryFmncSmpRef1NFile::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->refresh(dbsfmnc);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryFmncSmpRef1NFile::StgIac::JNUM)) {
...
void PnlFmncSmpRef1NFile::handleDpchAppDoButViewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint refSel;
...
void PnlFmncSmpRef1NFile::handleDpchAppDoButNewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlFmncSmpRef1NFile::handleDpchAppDoButDeleteClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncSmpRef1NFile::handleDpchAppDoButRefreshClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	set<uint> moditems;
...
void PnlFmncSmpRef1NFile::handleCall(
			DbsFmnc* dbsfmnc
			, Call* call
		) {
...
bool PnlFmncSmpRef1NFile::handleCallFmncStatChg(
			DbsFmnc* dbsfmnc
			, const ubigint jrefTrig
		) {
	bool retval = false;
