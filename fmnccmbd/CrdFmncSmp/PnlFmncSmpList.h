/**
  * \file PnlFmncSmpList.h
  * job handler for job PnlFmncSmpList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSMPLIST_H
#define PNLFMNCSMPLIST_H
...
/**
  * PnlFmncSmpList
  */
class PnlFmncSmpList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncSmpListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncSmpList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncSmpList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncSmpList)
		*/
	...
	public:
		...
		static const uint TCOMATWIDTH = 4;
		static const uint TCOSTEWIDTH = 5;

	public:
		StgIac(const uint TcoSrfWidth = 100, const uint TcoSupWidth = 100, const uint TcoArtWidth = 100, const uint TcoMatWidth = 100, const uint TcoSteWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppFmncSmpListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncSmpListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncSmpListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSmpList* rst = NULL, QryFmncSmpList::StatShr* statshrqry = NULL, QryFmncSmpList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSmpList::StatShr statshrqry;
		QryFmncSmpList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncSmpList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSmpList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSmpList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
