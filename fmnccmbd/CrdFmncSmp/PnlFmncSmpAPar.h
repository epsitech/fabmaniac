/**
  * \file PnlFmncSmpAPar.h
  * job handler for job PnlFmncSmpAPar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSMPAPAR_H
#define PNLFMNCSMPAPAR_H
...
/**
  * PnlFmncSmpAPar
  */
class PnlFmncSmpAPar : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncSmpAParDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncSmpAPar)
	  */
	...
	/**
		* StatApp (full: StatAppFmncSmpAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncSmpAPar)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncSmpAParData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncSmpAPar::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncSmpAParDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncSmpAParData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQSmpAPar* rst = NULL, QryFmncSmpAPar::StatShr* statshrqry = NULL, QryFmncSmpAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncSmpAPar::StatShr statshrqry;
		QryFmncSmpAPar::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncSmpAPar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncSmpAPar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncSmpAPar::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
