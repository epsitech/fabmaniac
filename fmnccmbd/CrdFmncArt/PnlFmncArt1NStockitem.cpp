/**
  ...
  * job handler for job PnlFmncArt1NStockitem (implementation)
...
#include "PnlFmncArt1NStockitem_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "PnlFmncArt1NStockitem_evals.cpp"
// IP evalsInclude --- END

/******************************************************************************
 class PnlFmncArt1NStockitem
 ******************************************************************************/

// IP constructor.hdr --- BEGIN
PnlFmncArt1NStockitem::PnlFmncArt1NStockitem(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::PNLFMNCART1NSTOCKITEM, jrefSup, ixFmncVLocale) {
...
// IP constructor.cust1 --- INSERT
	...
	qry = new QryFmncArt1NStockitem(xchg, dbsfmnc, jref, ixFmncVLocale);
...
// IP cust --- INSERT
DpchEngFmnc* PnlFmncArt1NStockitem::getNewDpchEng(
			set<uint> items
		) {
...
void PnlFmncArt1NStockitem::refresh(
			DbsFmnc* dbsfmnc
			, set<uint>& moditems
		) {
...
void PnlFmncArt1NStockitem::updatePreset(
			DbsFmnc* dbsfmnc
...
void PnlFmncArt1NStockitem::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCART1NSTOCKITEMDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCART1NSTOCKITEMDO) {
...
void PnlFmncArt1NStockitem::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void PnlFmncArt1NStockitem::handleDpchAppDataStgiac(
			DbsFmnc* dbsfmnc
			, StgIac* _stgiac
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncArt1NStockitem::handleDpchAppDoButViewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint refSel;
...
void PnlFmncArt1NStockitem::handleDpchAppDoButNewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlFmncArt1NStockitem::handleDpchAppDoButDeleteClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncArt1NStockitem::handleDpchAppDoButRefreshClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	set<uint> moditems;
...
void PnlFmncArt1NStockitem::handleCall(
			DbsFmnc* dbsfmnc
			, Call* call
		) {
...
bool PnlFmncArt1NStockitem::handleCallFmncStatChg(
			DbsFmnc* dbsfmnc
			, const ubigint jrefTrig
		) {
	bool retval = false;
