/**
  ...
  * job handler for job PnlFmncArtHeadbar (declarations)
...
/**
  * PnlFmncArtHeadbar
  */
class PnlFmncArtHeadbar : public JobFmnc {
...
// IP constructor --- BEGIN
	PnlFmncArtHeadbar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncArtHeadbar();
