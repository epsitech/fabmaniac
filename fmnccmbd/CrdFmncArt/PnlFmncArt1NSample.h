/**
  * \file PnlFmncArt1NSample.h
  * job handler for job PnlFmncArt1NSample (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCART1NSAMPLE_H
#define PNLFMNCART1NSAMPLE_H
...
/**
  * PnlFmncArt1NSample
  */
class PnlFmncArt1NSample : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncArt1NSampleDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncArt1NSample)
	  */
	...
	/**
		* StatApp (full: StatAppFmncArt1NSample)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncArt1NSample)
		*/
	...
	/**
		* StgIac (full: StgIacFmncArt1NSample)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncArt1NSampleData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncArt1NSampleDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncArt1NSampleData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQArt1NSample* rst = NULL, QryFmncArt1NSample::StatShr* statshrqry = NULL, QryFmncArt1NSample::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncArt1NSample(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncArt1NSample();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncArt1NSample::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
