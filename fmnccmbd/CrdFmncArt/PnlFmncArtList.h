/**
  ...
  * job handler for job PnlFmncArtList (declarations)
...
/**
  * PnlFmncArtList
  */
class PnlFmncArtList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQArtList* rst = NULL, QryFmncArtList::StatShr* statshrqry = NULL, QryFmncArtList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncArtList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncArtList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncArtList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
