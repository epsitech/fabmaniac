/**
  * \file QryFmncArtList.h
  * job handler for job QryFmncArtList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCARTLIST_H
#define QRYFMNCARTLIST_H
...
/**
  * QryFmncArtList
  */
class QryFmncArtList : public JobFmnc {

public:
	/**
		* VecVOrd (full: VecVQryFmncArtListOrd)
		*/
	class VecVOrd {

	public:
		static const uint SRF = 1;
		static const uint ORG = 2;
		static const uint TOL = 3;
	...
	/**
		* StatApp (full: StatAppQryFmncArtList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncArtList)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncArtList)
		*/
...
// IP constructor --- BEGIN
	QryFmncArtList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncArtList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preSrf, const ubigint preOrg, const ubigint preTol, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallFmncArtMod(DbsFmnc* dbsfmnc, const ubigint jrefTrig);
