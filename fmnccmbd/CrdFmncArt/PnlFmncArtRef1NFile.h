/**
  * \file PnlFmncArtRef1NFile.h
  * job handler for job PnlFmncArtRef1NFile (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCARTREF1NFILE_H
#define PNLFMNCARTREF1NFILE_H
...
/**
  * PnlFmncArtRef1NFile
  */
class PnlFmncArtRef1NFile : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncArtRef1NFileDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncArtRef1NFile)
	  */
	...
	/**
		* StatApp (full: StatAppFmncArtRef1NFile)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncArtRef1NFile)
		*/
	...
	/**
		* StgIac (full: StgIacFmncArtRef1NFile)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncArtRef1NFileData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncArtRef1NFile::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncArtRef1NFileDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncArtRef1NFileData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQArtRef1NFile* rst = NULL, QryFmncArtRef1NFile::StatShr* statshrqry = NULL, QryFmncArtRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncArtRef1NFile::StatShr statshrqry;
		QryFmncArtRef1NFile::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncArtRef1NFile(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncArtRef1NFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncArtRef1NFile::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
