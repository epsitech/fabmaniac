/**
  ...
  * job handler for job PnlFmncActDetail (declarations)
...
/**
  * PnlFmncActDetail
  */
class PnlFmncActDetail : public JobFmnc {
...
public:
	...
	bool evalButRunViewAvail(DbsFmnc* dbsfmnc);

public:
// IP constructor --- BEGIN
	PnlFmncActDetail(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncActDetail();
...
public:
	...
	void refreshRecAct(DbsFmnc* dbsfmnc, set<uint>& moditems);
