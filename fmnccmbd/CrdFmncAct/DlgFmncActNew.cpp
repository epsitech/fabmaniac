/**
  ...
  * job handler for job DlgFmncActNew (implementation)
...
#include "DlgFmncActNew_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "DlgFmncActNew_evals.cpp"
// IP evalsInclude --- END
...
DlgFmncActNew::DlgFmncActNew(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::DLGFMNCACTNEW, jrefSup, ixFmncVLocale) {
...
// IP cust --- INSERT
DpchEngFmnc* DlgFmncActNew::getNewDpchEng(
			set<uint> items
		) {
...
void DlgFmncActNew::changeStage(
			DbsFmnc* dbsfmnc
			, uint _ixVSge
			, DpchEngFmnc** dpcheng
		) {
...
uint DlgFmncActNew::enterSgeIdle(
			DbsFmnc* dbsfmnc
		) {
...
void DlgFmncActNew::leaveSgeIdle(
			DbsFmnc* dbsfmnc
		) {
// IP leaveSgeIdle --- INSERT
};

uint DlgFmncActNew::enterSgeCreate(
			DbsFmnc* dbsfmnc
		) {
...
void DlgFmncActNew::leaveSgeCreate(
			DbsFmnc* dbsfmnc
		) {
// IP leaveSgeCreate --- INSERT
};

uint DlgFmncActNew::enterSgeDone(
			DbsFmnc* dbsfmnc
		) {
...
void DlgFmncActNew::leaveSgeDone(
			DbsFmnc* dbsfmnc
		) {
// IP leaveSgeDone --- INSERT
};

string DlgFmncActNew::getSquawk(
			DbsFmnc* dbsfmnc
		) {
	string retval;
// IP getSquawk --- BEGIN
...
void DlgFmncActNew::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPDLGFMNCACTNEWDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPDLGFMNCACTNEWDO) {
...
void DlgFmncActNew::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void DlgFmncActNew::handleDpchAppDataContiac(
			DbsFmnc* dbsfmnc
			, ContIac* _contiac
			, DpchEngFmnc** dpcheng
		) {
...
void DlgFmncActNew::handleDpchAppDoButCncClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void DlgFmncActNew::handleDpchAppDoButCreClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
