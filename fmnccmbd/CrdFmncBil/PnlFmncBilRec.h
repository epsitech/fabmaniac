/**
  ...
  * job handler for job PnlFmncBilRec (declarations)
...
/**
  * PnlFmncBilRec
  */
class PnlFmncBilRec : public JobFmnc {
...
// IP constructor --- BEGIN
	PnlFmncBilRec(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncBilRec();
...
public:
	...
	PnlFmncBilDetail* pnldetail;
	PnlFmncBilAPos* pnlapos;
