/**
  ...
  * job handler for job QryFmncBilList (declarations)
...
/**
  * QryFmncBilList
  */
class QryFmncBilList : public JobFmnc {
...
// IP constructor --- BEGIN
	QryFmncBilList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncBilList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preSrf, const int preDat, const ubigint prePrj, const ubigint preFil, const uint preSte, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallFmncBilMod(DbsFmnc* dbsfmnc, const ubigint jrefTrig);
