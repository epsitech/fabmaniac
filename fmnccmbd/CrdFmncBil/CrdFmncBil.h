/**
  * \file CrdFmncBil.h
  * job handler for job CrdFmncBil (declarations)
...
/**
  * CrdFmncBil
  */
class CrdFmncBil : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncBilDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDBIL = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdBil = "");
	...
	/**
		* DpchAppDo (full: DpchAppFmncBilDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncBilData)
		*/
...
public:
	CrdFmncBil(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0, const uint ixFmncVPreset = VecFmncVPreset::VOID, const ubigint preUref = 0);
	~CrdFmncBil();
...
public:
	...
	PnlFmncBilRec* pnlrec;
	PnlFmncBilHeadbar* pnlheadbar;
	PnlFmncBilList* pnllist;
