/**
  ...
  * job handler for job PnlFmncBilList (declarations)
...
/**
  * PnlFmncBilList
  */
class PnlFmncBilList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQBilList* rst = NULL, QryFmncBilList::StatShr* statshrqry = NULL, QryFmncBilList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncBilList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncBilList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncBilList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
