/**
  * \file VecFmncVMimetype.cpp
  * vector VecFmncVMimetype (implementation)
...
/******************************************************************************
 namespace VecFmncVMimetype
 ******************************************************************************/

uint VecFmncVMimetype::getIx(
			const string& sref
		) {
...
string VecFmncVMimetype::getSref(
			const uint ix
		) {
...
string VecFmncVMimetype::getTitle(
			const uint ix
		) {
