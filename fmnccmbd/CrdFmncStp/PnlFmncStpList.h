/**
  ...
  * job handler for job PnlFmncStpList (declarations)
...
/**
  * PnlFmncStpList
  */
class PnlFmncStpList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQStpList* rst = NULL, QryFmncStpList::StatShr* statshrqry = NULL, QryFmncStpList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncStpList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncStpList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncStpList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
