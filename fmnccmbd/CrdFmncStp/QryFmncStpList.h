/**
  * \file QryFmncStpList.h
  * job handler for job QryFmncStpList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCSTPLIST_H
#define QRYFMNCSTPLIST_H
...
/**
  * QryFmncStpList
  */
class QryFmncStpList : public JobFmnc {

public:
	/**
		* VecVOrd (full: VecVQryFmncStpListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryFmncStpList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncStpList)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncStpList)
		*/
...
// IP constructor --- BEGIN
	QryFmncStpList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncStpList();
