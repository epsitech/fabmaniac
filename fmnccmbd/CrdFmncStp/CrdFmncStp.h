/**
  * \file CrdFmncStp.h
  * job handler for job CrdFmncStp (declarations)
...
/**
  * CrdFmncStp
  */
class CrdFmncStp : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncStpDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDSTP = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdStp = "");
	...
	/**
		* DpchAppDo (full: DpchAppFmncStpDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncStpData)
		*/
...
public:
	CrdFmncStp(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncStp();
...
public:
	...
	PnlFmncStpRec* pnlrec;
	PnlFmncStpHeadbar* pnlheadbar;
	PnlFmncStpList* pnllist;
