/**
  ...
  * job handler for job PnlFmncStpMNFile (declarations)
...
/**
  * PnlFmncStpMNFile
  */
class PnlFmncStpMNFile : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQStpMNFile* rst = NULL, QryFmncStpMNFile::StatShr* statshrqry = NULL, QryFmncStpMNFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncStpMNFile(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncStpMNFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncStpMNFile::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
