/**
  * \file PnlFmncStpRef1NFile.h
  * job handler for job PnlFmncStpRef1NFile (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCSTPREF1NFILE_H
#define PNLFMNCSTPREF1NFILE_H
...
/**
  * PnlFmncStpRef1NFile
  */
class PnlFmncStpRef1NFile : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncStpRef1NFileDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncStpRef1NFile)
	  */
	...
	/**
		* StatApp (full: StatAppFmncStpRef1NFile)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncStpRef1NFile)
		*/
	...
	/**
		* StgIac (full: StgIacFmncStpRef1NFile)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncStpRef1NFileData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncStpRef1NFileDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncStpRef1NFileData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQStpRef1NFile* rst = NULL, QryFmncStpRef1NFile::StatShr* statshrqry = NULL, QryFmncStpRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncStpRef1NFile(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncStpRef1NFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncStpRef1NFile::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
