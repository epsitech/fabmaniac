/**
  * \file QryFmncStpKSteppar.h
  * job handler for job QryFmncStpKSteppar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCSTPKSTEPPAR_H
#define QRYFMNCSTPKSTEPPAR_H
...
/**
  * QryFmncStpKSteppar
  */
class QryFmncStpKSteppar : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncStpKSteppar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncStpKSteppar)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncStpKSteppar)
		*/
...
// IP constructor --- BEGIN
	QryFmncStpKSteppar(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncStpKSteppar();
