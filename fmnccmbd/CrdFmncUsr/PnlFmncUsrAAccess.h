/**
  ...
  * job handler for job PnlFmncUsrAAccess (declarations)
...
/**
  * PnlFmncUsrAAccess
  */
class PnlFmncUsrAAccess : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQUsrAAccess* rst = NULL, QryFmncUsrAAccess::StatShr* statshrqry = NULL, QryFmncUsrAAccess::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncUsrAAccess(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsrAAccess();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncUsrAAccess::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
