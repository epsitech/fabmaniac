/**
  ...
  * job handler for job QryFmncUsr1NSession (declarations)
...
/**
  * QryFmncUsr1NSession
  */
class QryFmncUsr1NSession : public JobFmnc {
...
// IP constructor --- BEGIN
	QryFmncUsr1NSession(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncUsr1NSession();
...
// IP handleCall --- END
	...
	bool handleCallFmncSesMod_usrEq(DbsFmnc* dbsfmnc, const ubigint jrefTrig, const ubigint refInv);
};
