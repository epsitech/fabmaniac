/**
  * \file PnlFmncUsrList.h
  * job handler for job PnlFmncUsrList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCUSRLIST_H
#define PNLFMNCUSRLIST_H
...
/**
  * PnlFmncUsrList
  */
class PnlFmncUsrList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncUsrListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncUsrList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncUsrList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncUsrList)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncUsrListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncUsrListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncUsrListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQUsrList* rst = NULL, QryFmncUsrList::StatShr* statshrqry = NULL, QryFmncUsrList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncUsrList::StatShr statshrqry;
		QryFmncUsrList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncUsrList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsrList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncUsrList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
