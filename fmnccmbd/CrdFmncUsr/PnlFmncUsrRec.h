/**
  ...
  * job handler for job PnlFmncUsrRec (declarations)
...
/**
  * PnlFmncUsrRec
  */
class PnlFmncUsrRec : public JobFmnc {
...
public:
	...
	public:
		StatShr(const uint ixFmncVExpstate = VecFmncVExpstate::REGD, const ubigint jrefDetail = 0, const ubigint jrefAAccess = 0, const ubigint jref1NSession = 0, const ubigint jrefMNUsergroup = 0, const bool ButRegularizeActive = true);
...
// IP constructor --- BEGIN
	PnlFmncUsrRec(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsrRec();
...
public:
	...
	PnlFmncUsrDetail* pnldetail;
	PnlFmncUsrAAccess* pnlaaccess;
	PnlFmncUsr1NSession* pnl1nsession;
	PnlFmncUsrMNUsergroup* pnlmnusergroup;
