/**
  * \file CrdFmncUsr.h
  * job handler for job CrdFmncUsr (declarations)
...
/**
  * CrdFmncUsr
  */
class CrdFmncUsr : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncUsrDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppFmncUsrDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncUsrData)
		*/
...
public:
	CrdFmncUsr(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncUsr();
...
public:
	...
	PnlFmncUsrRec* pnlrec;
	PnlFmncUsrHeadbar* pnlheadbar;
	PnlFmncUsrList* pnllist;
