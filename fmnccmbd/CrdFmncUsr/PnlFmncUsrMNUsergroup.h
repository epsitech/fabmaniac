/**
  * \file PnlFmncUsrMNUsergroup.h
  * job handler for job PnlFmncUsrMNUsergroup (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCUSRMNUSERGROUP_H
#define PNLFMNCUSRMNUSERGROUP_H
...
/**
  * PnlFmncUsrMNUsergroup
  */
class PnlFmncUsrMNUsergroup : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncUsrMNUsergroupDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncUsrMNUsergroup)
	  */
	...
	/**
		* StatApp (full: StatAppFmncUsrMNUsergroup)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncUsrMNUsergroup)
		*/
	...
	/**
		* StgIac (full: StgIacFmncUsrMNUsergroup)
		*/
	...
	/**
		* Tag (full: TagFmncUsrMNUsergroup)
		*/
	class Tag {
	...
	/**
		* DpchAppData (full: DpchAppFmncUsrMNUsergroupData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncUsrMNUsergroup::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncUsrMNUsergroupDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncUsrMNUsergroupData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQUsrMNUsergroup* rst = NULL, QryFmncUsrMNUsergroup::StatShr* statshrqry = NULL, QryFmncUsrMNUsergroup::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncUsrMNUsergroup::StatShr statshrqry;
		QryFmncUsrMNUsergroup::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncUsrMNUsergroup(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsrMNUsergroup();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncUsrMNUsergroup::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
