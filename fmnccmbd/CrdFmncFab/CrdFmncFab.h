/**
  * \file CrdFmncFab.h
  * job handler for job CrdFmncFab (declarations)
...
/**
  * CrdFmncFab
  */
class CrdFmncFab : public JobFmnc {
...
public:
	...
	public:
		static const uint JREFDLGEXPFAB = 1;
		static const uint JREFDLGIMPFAB = 2;
	...
	public:
		StatShr(const ubigint jrefDlgexpfab = 0, const ubigint jrefDlgimpfab = 0, const ubigint jrefDlgnew = 0, const ubigint jrefHeadbar = 0, const ubigint jrefList = 0, const ubigint jrefRec = 0, const bool MspCrd1Avail = true, const bool MitCrdNewAvail = true, const bool MitCrdImfAvail = true, const bool MitCrdExfActive = true);

	public:
		ubigint jrefDlgexpfab;
		ubigint jrefDlgimpfab;
		ubigint jrefDlgnew;
		ubigint jrefHeadbar;
		ubigint jrefList;
		ubigint jrefRec;
	...
	bool evalMitCrdImfAvail(DbsFmnc* dbsfmnc);
	bool evalMitCrdExfActive(DbsFmnc* dbsfmnc);

public:
	CrdFmncFab(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncFab();
...
public:
	...
	DlgFmncFabExpfab* dlgexpfab;
	DlgFmncFabImpfab* dlgimpfab;
	DlgFmncFabNew* dlgnew;
	PnlFmncFabRec* pnlrec;
	PnlFmncFabHeadbar* pnlheadbar;
	PnlFmncFabList* pnllist;
...
// IP getSquawk --- END
	...
	void handleDpchAppDoMitCrdImfClick(DbsFmnc* dbsfmnc, DpchEngFmnc** dpcheng);
	void handleDpchAppDoMitCrdExfClick(DbsFmnc* dbsfmnc, DpchEngFmnc** dpcheng);
