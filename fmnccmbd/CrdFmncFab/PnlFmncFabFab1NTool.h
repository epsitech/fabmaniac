/**
  * \file PnlFmncFabFab1NTool.h
  * job handler for job PnlFmncFabFab1NTool (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFABFAB1NTOOL_H
#define PNLFMNCFABFAB1NTOOL_H
...
/**
  * PnlFmncFabFab1NTool
  */
class PnlFmncFabFab1NTool : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFabFab1NToolDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncFabFab1NTool)
	  */
	...
	/**
		* StatApp (full: StatAppFmncFabFab1NTool)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncFabFab1NTool)
		*/
	...
	/**
		* StgIac (full: StgIacFmncFabFab1NTool)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncFabFab1NToolData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncFabFab1NToolDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFabFab1NToolData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFabFab1NTool* rst = NULL, QryFmncFabFab1NTool::StatShr* statshrqry = NULL, QryFmncFabFab1NTool::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFabFab1NTool(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFabFab1NTool();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFabFab1NTool::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
