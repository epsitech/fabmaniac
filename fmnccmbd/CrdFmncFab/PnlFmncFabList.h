/**
  * \file PnlFmncFabList.h
  * job handler for job PnlFmncFabList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFABLIST_H
#define PNLFMNCFABLIST_H
...
/**
  * PnlFmncFabList
  */
class PnlFmncFabList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFabListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncFabList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncFabList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncFabList)
		*/
	...
	public:
		StgIac(const uint TcoOrgWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppFmncFabListData)
		*/
	...
	public:
		ContIac contiac;
		StgIac stgiac;
		QryFmncFabList::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncFabListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFabListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFabList* rst = NULL, QryFmncFabList::StatShr* statshrqry = NULL, QryFmncFabList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFabList::StatShr statshrqry;
		QryFmncFabList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncFabList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFabList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFabList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
