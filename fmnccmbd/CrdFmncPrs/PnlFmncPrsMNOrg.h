/**
  ...
  * job handler for job PnlFmncPrsMNOrg (declarations)
...
/**
  * PnlFmncPrsMNOrg
  */
class PnlFmncPrsMNOrg : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQPrsMNOrg* rst = NULL, QryFmncPrsMNOrg::StatShr* statshrqry = NULL, QryFmncPrsMNOrg::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncPrsMNOrg(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncPrsMNOrg();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncPrsMNOrg::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
