/**
  * \file QryFmncPrsADetail.h
  * job handler for job QryFmncPrsADetail (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCPRSADETAIL_H
#define QRYFMNCPRSADETAIL_H
...
/**
  * QryFmncPrsADetail
  */
class QryFmncPrsADetail : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncPrsADetail)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncPrsADetail)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncPrsADetail)
		*/
...
// IP constructor --- BEGIN
	QryFmncPrsADetail(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncPrsADetail();
...
// IP handleCall --- END
	...
	bool handleCallFmncPrsAdetMod_prsEq(DbsFmnc* dbsfmnc, const ubigint jrefTrig, const ubigint refInv);
};
