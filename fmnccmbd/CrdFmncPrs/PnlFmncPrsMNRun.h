/**
  * \file PnlFmncPrsMNRun.h
  * job handler for job PnlFmncPrsMNRun (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCPRSMNRUN_H
#define PNLFMNCPRSMNRUN_H
...
/**
  * PnlFmncPrsMNRun
  */
class PnlFmncPrsMNRun : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncPrsMNRunDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncPrsMNRun)
	  */
	...
	/**
		* StatApp (full: StatAppFmncPrsMNRun)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncPrsMNRun)
		*/
	...
	/**
		* StgIac (full: StgIacFmncPrsMNRun)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncPrsMNRunData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncPrsMNRun::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncPrsMNRunDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncPrsMNRunData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQPrsMNRun* rst = NULL, QryFmncPrsMNRun::StatShr* statshrqry = NULL, QryFmncPrsMNRun::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncPrsMNRun::StatShr statshrqry;
		QryFmncPrsMNRun::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncPrsMNRun(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncPrsMNRun();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncPrsMNRun::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
