/**
  * \file PnlFmncPrsHk1NAddress.cpp
  * job handler for job PnlFmncPrsHk1NAddress (implementation)
...
#include "PnlFmncPrsHk1NAddress_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "PnlFmncPrsHk1NAddress_evals.cpp"
// IP evalsInclude --- END

/******************************************************************************
 class PnlFmncPrsHk1NAddress
 ******************************************************************************/

// IP constructor.hdr --- BEGIN
PnlFmncPrsHk1NAddress::PnlFmncPrsHk1NAddress(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::PNLFMNCPRSHK1NADDRESS, jrefSup, ixFmncVLocale) {
...
// IP constructor.cust1 --- INSERT
	...
	qry = new QryFmncPrsHk1NAddress(xchg, dbsfmnc, jref, ixFmncVLocale);
...
// IP cust --- INSERT
DpchEngFmnc* PnlFmncPrsHk1NAddress::getNewDpchEng(
			set<uint> items
		) {
...
void PnlFmncPrsHk1NAddress::refresh(
			DbsFmnc* dbsfmnc
			, set<uint>& moditems
		) {
...
void PnlFmncPrsHk1NAddress::updatePreset(
			DbsFmnc* dbsfmnc
...
void PnlFmncPrsHk1NAddress::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCPRSHK1NADDRESSDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCPRSHK1NADDRESSDO) {
...
void PnlFmncPrsHk1NAddress::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void PnlFmncPrsHk1NAddress::handleDpchAppDataStgiac(
			DbsFmnc* dbsfmnc
			, StgIac* _stgiac
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncPrsHk1NAddress::handleDpchAppDataStgiacqry(
			DbsFmnc* dbsfmnc
			, QryFmncPrsHk1NAddress::StgIac* _stgiacqry
			, DpchEngFmnc** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryFmncPrsHk1NAddress::StgIac::JNUM)) refSelNew = qry->getRefByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryFmncPrsHk1NAddress::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->refresh(dbsfmnc);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryFmncPrsHk1NAddress::StgIac::JNUM)) {
...
void PnlFmncPrsHk1NAddress::handleDpchAppDoButViewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint refSel;
...
void PnlFmncPrsHk1NAddress::handleDpchAppDoButNewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlFmncPrsHk1NAddress::handleDpchAppDoButDeleteClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncPrsHk1NAddress::handleDpchAppDoButRefreshClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	set<uint> moditems;
...
void PnlFmncPrsHk1NAddress::handleCall(
			DbsFmnc* dbsfmnc
			, Call* call
		) {
...
bool PnlFmncPrsHk1NAddress::handleCallFmncStatChg(
			DbsFmnc* dbsfmnc
			, const ubigint jrefTrig
		) {
	bool retval = false;
