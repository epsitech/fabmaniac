/**
  ...
  * job handler for job PnlFmncFilMNSample (declarations)
...
/**
  * PnlFmncFilMNSample
  */
class PnlFmncFilMNSample : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFilMNSample* rst = NULL, QryFmncFilMNSample::StatShr* statshrqry = NULL, QryFmncFilMNSample::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFilMNSample(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFilMNSample();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFilMNSample::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
