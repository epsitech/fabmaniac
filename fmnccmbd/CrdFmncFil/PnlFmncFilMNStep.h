/**
  ...
  * job handler for job PnlFmncFilMNStep (declarations)
...
/**
  * PnlFmncFilMNStep
  */
class PnlFmncFilMNStep : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFilMNStep* rst = NULL, QryFmncFilMNStep::StatShr* statshrqry = NULL, QryFmncFilMNStep::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFilMNStep(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFilMNStep();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFilMNStep::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
