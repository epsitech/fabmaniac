/**
  * \file PnlFmncFilList.h
  * job handler for job PnlFmncFilList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFILLIST_H
#define PNLFMNCFILLIST_H
...
/**
  * PnlFmncFilList
  */
class PnlFmncFilList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFilListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncFilList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncFilList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncFilList)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncFilListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncFilListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFilListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFilList* rst = NULL, QryFmncFilList::StatShr* statshrqry = NULL, QryFmncFilList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFilList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFilList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFilList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
