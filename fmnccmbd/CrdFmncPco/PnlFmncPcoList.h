/**
  ...
  * job handler for job PnlFmncPcoList (declarations)
...
/**
  * PnlFmncPcoList
  */
class PnlFmncPcoList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQPcoList* rst = NULL, QryFmncPcoList::StatShr* statshrqry = NULL, QryFmncPcoList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncPcoList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncPcoList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncPcoList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
