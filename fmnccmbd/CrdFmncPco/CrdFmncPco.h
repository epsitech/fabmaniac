/**
  * \file CrdFmncPco.h
  * job handler for job CrdFmncPco (declarations)
...
/**
  * CrdFmncPco
  */
class CrdFmncPco : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncPcoDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDPCO = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdPco = "");
	...
	/**
		* DpchAppDo (full: DpchAppFmncPcoDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncPcoData)
		*/
...
public:
	CrdFmncPco(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncPco();
...
public:
	...
	PnlFmncPcoRec* pnlrec;
	PnlFmncPcoHeadbar* pnlheadbar;
	PnlFmncPcoList* pnllist;
