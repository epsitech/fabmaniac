/**
  ...
  * job handler for job PnlFmncPcoAPos (declarations)
...
/**
  * PnlFmncPcoAPos
  */
class PnlFmncPcoAPos : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQPcoAPos* rst = NULL, QryFmncPcoAPos::StatShr* statshrqry = NULL, QryFmncPcoAPos::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncPcoAPos(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncPcoAPos();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncPcoAPos::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
