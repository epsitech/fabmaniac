/**
  * \file PnlFmncFpjList.h
  * job handler for job PnlFmncFpjList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFPJLIST_H
#define PNLFMNCFPJLIST_H
...
/**
  * PnlFmncFpjList
  */
class PnlFmncFpjList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFpjListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncFpjList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncFpjList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncFpjList)
		*/
	...
	public:
		...
		static const uint TCOBIOWIDTH = 4;
		static const uint TCOSTEWIDTH = 5;

	public:
		StgIac(const uint TcoSrfWidth = 100, const uint TcoTitWidth = 100, const uint TcoFabWidth = 100, const uint TcoBioWidth = 100, const uint TcoSteWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppFmncFpjListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncFpjListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFpjListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFpjList* rst = NULL, QryFmncFpjList::StatShr* statshrqry = NULL, QryFmncFpjList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFpjList::StatShr statshrqry;
		QryFmncFpjList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncFpjList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFpjList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFpjList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
