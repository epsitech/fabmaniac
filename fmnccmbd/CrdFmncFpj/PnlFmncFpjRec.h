/**
  ...
  * job handler for job PnlFmncFpjRec (declarations)
...
/**
  * PnlFmncFpjRec
  */
class PnlFmncFpjRec : public JobFmnc {
...
public:
	...
	public:
		static void writeXML(xmlTextWriter* wr, string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdone1NBill = false, const bool initdoneMNFabuser = false);
	};
	...
	public:
		...
		static const uint JREF1NBILL = 3;
		static const uint JREFMNFABUSER = 4;
		static const uint BUTREGULARIZEACTIVE = 5;

	public:
		StatShr(const uint ixFmncVExpstate = VecFmncVExpstate::REGD, const ubigint jrefDetail = 0, const ubigint jref1NBill = 0, const ubigint jrefMNFabuser = 0, const bool ButRegularizeActive = true);
...
// IP constructor --- BEGIN
	PnlFmncFpjRec(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFpjRec();
...
public:
	...
	PnlFmncFpjDetail* pnldetail;
	PnlFmncFpj1NBill* pnl1nbill;
	PnlFmncFpjMNFabuser* pnlmnfabuser;
