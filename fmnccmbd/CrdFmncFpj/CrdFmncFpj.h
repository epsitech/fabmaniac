/**
  * \file CrdFmncFpj.h
  * job handler for job CrdFmncFpj (declarations)
...
/**
  * CrdFmncFpj
  */
class CrdFmncFpj : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFpjDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDFPJ = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdFpj = "");
	...
	/**
		* DpchAppDo (full: DpchAppFmncFpjDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFpjData)
		*/
...
public:
	CrdFmncFpj(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0, const uint ixFmncVPreset = VecFmncVPreset::VOID, const ubigint preUref = 0);
	~CrdFmncFpj();
...
public:
	...
	PnlFmncFpjRec* pnlrec;
	PnlFmncFpjHeadbar* pnlheadbar;
	PnlFmncFpjList* pnllist;
