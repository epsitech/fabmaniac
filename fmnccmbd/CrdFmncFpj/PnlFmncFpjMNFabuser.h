/**
  * \file PnlFmncFpjMNFabuser.h
  * job handler for job PnlFmncFpjMNFabuser (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFPJMNFABUSER_H
#define PNLFMNCFPJMNFABUSER_H
...
/**
  * PnlFmncFpjMNFabuser
  */
class PnlFmncFpjMNFabuser : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFpjMNFabuserDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncFpjMNFabuser)
	  */
	...
	/**
		* StatApp (full: StatAppFmncFpjMNFabuser)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncFpjMNFabuser)
		*/
	...
	/**
		* StgIac (full: StgIacFmncFpjMNFabuser)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncFpjMNFabuserData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncFpjMNFabuser::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncFpjMNFabuserDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFpjMNFabuserData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFpjMNFabuser* rst = NULL, QryFmncFpjMNFabuser::StatShr* statshrqry = NULL, QryFmncFpjMNFabuser::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncFpjMNFabuser::StatShr statshrqry;
		QryFmncFpjMNFabuser::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncFpjMNFabuser(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFpjMNFabuser();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFpjMNFabuser::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
