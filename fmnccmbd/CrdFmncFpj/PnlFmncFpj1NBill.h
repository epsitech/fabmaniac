/**
  * \file PnlFmncFpj1NBill.h
  * job handler for job PnlFmncFpj1NBill (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCFPJ1NBILL_H
#define PNLFMNCFPJ1NBILL_H
...
/**
  * PnlFmncFpj1NBill
  */
class PnlFmncFpj1NBill : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFpj1NBillDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncFpj1NBill)
	  */
	...
	/**
		* StatApp (full: StatAppFmncFpj1NBill)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncFpj1NBill)
		*/
	...
	/**
		* StgIac (full: StgIacFmncFpj1NBill)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncFpj1NBillData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncFpj1NBillDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFpj1NBillData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFpj1NBill* rst = NULL, QryFmncFpj1NBill::StatShr* statshrqry = NULL, QryFmncFpj1NBill::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFpj1NBill(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFpj1NBill();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFpj1NBill::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
