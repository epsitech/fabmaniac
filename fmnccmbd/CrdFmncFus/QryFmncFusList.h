/**
  * \file QryFmncFusList.h
  * job handler for job QryFmncFusList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCFUSLIST_H
#define QRYFMNCFUSLIST_H
...
/**
  * QryFmncFusList
  */
class QryFmncFusList : public JobFmnc {

public:
	/**
		* VecVOrd (full: VecVQryFmncFusListOrd)
		*/
	class VecVOrd {
	...
	public:
		...
		static const uint FAB = 3;
		static const uint FPJ = 4;
		static const uint STE = 5;
	...
	/**
		* StatApp (full: StatAppQryFmncFusList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncFusList)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncFusList)
		*/
...
// IP constructor --- BEGIN
	QryFmncFusList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncFusList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const ubigint prePrs, const string& preSrf, const ubigint preFab, const ubigint preFpj, const uint preSte, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallFmncFusMod(DbsFmnc* dbsfmnc, const ubigint jrefTrig);
