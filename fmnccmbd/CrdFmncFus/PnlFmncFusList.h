/**
  ...
  * job handler for job PnlFmncFusList (declarations)
...
/**
  * PnlFmncFusList
  */
class PnlFmncFusList : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFusList* rst = NULL, QryFmncFusList::StatShr* statshrqry = NULL, QryFmncFusList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFusList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFusList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFusList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
