/**
  ...
  * job handler for job PnlFmncFusMNTool (declarations)
...
/**
  * PnlFmncFusMNTool
  */
class PnlFmncFusMNTool : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQFusMNTool* rst = NULL, QryFmncFusMNTool::StatShr* statshrqry = NULL, QryFmncFusMNTool::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncFusMNTool(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncFusMNTool();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncFusMNTool::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
