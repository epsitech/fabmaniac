/**
  * \file CrdFmncFus.h
  * job handler for job CrdFmncFus (declarations)
...
/**
  * CrdFmncFus
  */
class CrdFmncFus : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncFusDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDFUS = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdFus = "");
	...
	/**
		* DpchAppDo (full: DpchAppFmncFusDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncFusData)
		*/
...
public:
	CrdFmncFus(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0, const uint ixFmncVPreset = VecFmncVPreset::VOID, const ubigint preUref = 0);
	~CrdFmncFus();
...
public:
	...
	PnlFmncFusRec* pnlrec;
	PnlFmncFusHeadbar* pnlheadbar;
	PnlFmncFusList* pnllist;
