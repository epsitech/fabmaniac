/**
  * \file CrdFmncAdr.h
  * job handler for job CrdFmncAdr (declarations)
...
/**
  * CrdFmncAdr
  */
class CrdFmncAdr : public JobFmnc {
...
public:
	CrdFmncAdr(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncAdr();
...
public:
	...
	PnlFmncAdrRec* pnlrec;
	PnlFmncAdrHeadbar* pnlheadbar;
	PnlFmncAdrList* pnllist;
