/**
  * \file PnlFmncAdrRec.h
  * job handler for job PnlFmncAdrRec (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCADRREC_H
#define PNLFMNCADRREC_H
...
/**
  * PnlFmncAdrRec
  */
class PnlFmncAdrRec : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncAdrRecDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncAdrRec)
	  */
	...
	/**
		* StatApp (full: StatAppFmncAdrRec)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncAdrRec)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncAdrRecDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncAdrRecData)
		*/
...
// IP constructor --- BEGIN
	PnlFmncAdrRec(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncAdrRec();
