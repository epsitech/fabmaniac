/**
  ...
  * job handler for job DlgFmncOrgNew (declarations)
...
/**
  * DlgFmncOrgNew
  */
class DlgFmncOrgNew : public JobFmnc {
...
// IP constructor --- BEGIN
	DlgFmncOrgNew(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~DlgFmncOrgNew();
