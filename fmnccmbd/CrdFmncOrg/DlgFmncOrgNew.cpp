/**
  ...
  * job handler for job DlgFmncOrgNew (implementation)
...
#include "DlgFmncOrgNew_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "DlgFmncOrgNew_evals.cpp"
// IP evalsInclude --- END
...
DlgFmncOrgNew::DlgFmncOrgNew(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::DLGFMNCORGNEW, jrefSup, ixFmncVLocale) {
...
// IP cust --- INSERT
DpchEngFmnc* DlgFmncOrgNew::getNewDpchEng(
			set<uint> items
		) {
...
void DlgFmncOrgNew::changeStage(
			DbsFmnc* dbsfmnc
			, uint _ixVSge
			, DpchEngFmnc** dpcheng
		) {
...
uint DlgFmncOrgNew::enterSgeIdle(
			DbsFmnc* dbsfmnc
		) {
...
void DlgFmncOrgNew::leaveSgeIdle(
			DbsFmnc* dbsfmnc
		) {
// IP leaveSgeIdle --- INSERT
};

uint DlgFmncOrgNew::enterSgeCreate(
			DbsFmnc* dbsfmnc
		) {
...
void DlgFmncOrgNew::leaveSgeCreate(
			DbsFmnc* dbsfmnc
		) {
// IP leaveSgeCreate --- INSERT
};

uint DlgFmncOrgNew::enterSgeDone(
			DbsFmnc* dbsfmnc
		) {
...
void DlgFmncOrgNew::leaveSgeDone(
			DbsFmnc* dbsfmnc
		) {
// IP leaveSgeDone --- INSERT
};

string DlgFmncOrgNew::getSquawk(
			DbsFmnc* dbsfmnc
		) {
	string retval;
// IP getSquawk --- BEGIN
...
void DlgFmncOrgNew::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPDLGFMNCORGNEWDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPDLGFMNCORGNEWDO) {
...
void DlgFmncOrgNew::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void DlgFmncOrgNew::handleDpchAppDataContiac(
			DbsFmnc* dbsfmnc
			, ContIac* _contiac
			, DpchEngFmnc** dpcheng
		) {
...
void DlgFmncOrgNew::handleDpchAppDoButCncClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void DlgFmncOrgNew::handleDpchAppDoButCreClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
