/**
  * \file QryFmncOrgKStocklcn.h
  * job handler for job QryFmncOrgKStocklcn (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCORGKSTOCKLCN_H
#define QRYFMNCORGKSTOCKLCN_H
...
/**
  * QryFmncOrgKStocklcn
  */
class QryFmncOrgKStocklcn : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncOrgKStocklcn)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncOrgKStocklcn)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncOrgKStocklcn)
		*/
...
// IP constructor --- BEGIN
	QryFmncOrgKStocklcn(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncOrgKStocklcn();
