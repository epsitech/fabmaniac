/**
  * \file QryFmncOrgHk1NAddress.h
  * job handler for job QryFmncOrgHk1NAddress (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCORGHK1NADDRESS_H
#define QRYFMNCORGHK1NADDRESS_H

// IP custInclude --- INSERT

/**
  * QryFmncOrgHk1NAddress
  */
class QryFmncOrgHk1NAddress : public JobFmnc {

public:
	/**
		* StatApp (full: StatAppQryFmncOrgHk1NAddress)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncOrgHk1NAddress)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncOrgHk1NAddress)
		*/
...
// IP constructor --- BEGIN
	QryFmncOrgHk1NAddress(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncOrgHk1NAddress();
