/**
  * \file PnlFmncOrgKStocklcn.h
  * job handler for job PnlFmncOrgKStocklcn (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCORGKSTOCKLCN_H
#define PNLFMNCORGKSTOCKLCN_H
...
/**
  * PnlFmncOrgKStocklcn
  */
class PnlFmncOrgKStocklcn : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncOrgKStocklcnDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncOrgKStocklcn)
	  */
	...
	/**
		* StatApp (full: StatAppFmncOrgKStocklcn)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncOrgKStocklcn)
		*/
	...
	/**
		* StgIac (full: StgIacFmncOrgKStocklcn)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncOrgKStocklcnData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncOrgKStocklcnDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncOrgKStocklcnData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQOrgKStocklcn* rst = NULL, QryFmncOrgKStocklcn::StatShr* statshrqry = NULL, QryFmncOrgKStocklcn::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncOrgKStocklcn(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncOrgKStocklcn();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncOrgKStocklcn::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
