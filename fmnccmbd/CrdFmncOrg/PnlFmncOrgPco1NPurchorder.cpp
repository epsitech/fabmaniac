/**
  * \file PnlFmncOrgPco1NPurchorder.cpp
  * job handler for job PnlFmncOrgPco1NPurchorder (implementation)
...
#include "PnlFmncOrgPco1NPurchorder_blks.cpp"
// IP blksInclude --- END
// IP evalsInclude --- BEGIN
#include "PnlFmncOrgPco1NPurchorder_evals.cpp"
// IP evalsInclude --- END

/******************************************************************************
 class PnlFmncOrgPco1NPurchorder
 ******************************************************************************/

// IP constructor.hdr --- BEGIN
PnlFmncOrgPco1NPurchorder::PnlFmncOrgPco1NPurchorder(
			XchgFmnc* xchg
			, DbsFmnc* dbsfmnc
			, const ubigint jrefSup
			, const uint ixFmncVLocale
		) : JobFmnc(xchg, VecFmncVJob::PNLFMNCORGPCO1NPURCHORDER, jrefSup, ixFmncVLocale) {
...
// IP constructor.cust1 --- INSERT
	...
	qry = new QryFmncOrgPco1NPurchorder(xchg, dbsfmnc, jref, ixFmncVLocale);
...
// IP cust --- INSERT
DpchEngFmnc* PnlFmncOrgPco1NPurchorder::getNewDpchEng(
			set<uint> items
		) {
...
void PnlFmncOrgPco1NPurchorder::refresh(
			DbsFmnc* dbsfmnc
			, set<uint>& moditems
		) {
...
void PnlFmncOrgPco1NPurchorder::updatePreset(
			DbsFmnc* dbsfmnc
...
void PnlFmncOrgPco1NPurchorder::handleRequest(
			DbsFmnc* dbsfmnc
			, ReqFmnc* req
		) {
	if (req->ixVBasetype == ReqFmnc::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCORGPCO1NPURCHORDERDATA) {
		...
		} else if (req->dpchapp->ixFmncVDpch == VecFmncVDpch::DPCHAPPFMNCORGPCO1NPURCHORDERDO) {
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppFmncInit(
			DbsFmnc* dbsfmnc
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppDataStgiac(
			DbsFmnc* dbsfmnc
			, StgIac* _stgiac
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppDataStgiacqry(
			DbsFmnc* dbsfmnc
			, QryFmncOrgPco1NPurchorder::StgIac* _stgiacqry
			, DpchEngFmnc** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryFmncOrgPco1NPurchorder::StgIac::JNUM)) refSelNew = qry->getRefByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryFmncOrgPco1NPurchorder::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->refresh(dbsfmnc);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryFmncOrgPco1NPurchorder::StgIac::JNUM)) {
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppDoButViewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint refSel;
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppDoButNewClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppDoButDeleteClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
...
void PnlFmncOrgPco1NPurchorder::handleDpchAppDoButRefreshClick(
			DbsFmnc* dbsfmnc
			, DpchEngFmnc** dpcheng
		) {
	set<uint> moditems;
...
void PnlFmncOrgPco1NPurchorder::handleCall(
			DbsFmnc* dbsfmnc
			, Call* call
		) {
...
bool PnlFmncOrgPco1NPurchorder::handleCallFmncStatChg(
			DbsFmnc* dbsfmnc
			, const ubigint jrefTrig
		) {
	bool retval = false;
