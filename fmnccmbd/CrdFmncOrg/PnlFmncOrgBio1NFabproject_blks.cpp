/**
  * \file PnlFmncOrgBio1NFabproject_blks.cpp
  * job handler for job PnlFmncOrgBio1NFabproject (implementation of blocks)
...
void PnlFmncOrgBio1NFabproject::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContInfFmncOrgBio1NFabproject";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfFmncOrgBio1NFabproject";
...
void PnlFmncOrgBio1NFabproject::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixFmncVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppFmncOrgBio1NFabproject";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppFmncOrgBio1NFabproject";
...
void PnlFmncOrgBio1NFabproject::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrFmncOrgBio1NFabproject";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrFmncOrgBio1NFabproject";
...
void PnlFmncOrgBio1NFabproject::Tag::writeXML(
			const uint ixFmncVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "TagFmncOrgBio1NFabproject";

	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemFmncOrgBio1NFabproject";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixFmncVLocale == VecFmncVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Billed fab projects");
			writeStringAttr(wr, itemtag, "sref", "TcoRef", "Fab project");
		} else if (ixFmncVLocale == VecFmncVLocale::DECH) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Berechnete Reinraumprojekte");
			writeStringAttr(wr, itemtag, "sref", "TcoRef", "Reinraumprojekt");
		} else if (ixFmncVLocale == VecFmncVLocale::FRCH) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Projets salle blanche facturis\\u00e9s");
...
PnlFmncOrgBio1NFabproject::DpchAppData::DpchAppData() : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGBIO1NFABPROJECTDATA) {
};
...
void PnlFmncOrgBio1NFabproject::DpchAppData::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppFmncOrgBio1NFabprojectData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlFmncOrgBio1NFabproject::DpchAppDo::DpchAppDo() : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGBIO1NFABPROJECTDO) {
	ixVDo = 0;
};
...
void PnlFmncOrgBio1NFabproject::DpchAppDo::readXML(
			pthread_mutex_t* mScr
			, map<string,ubigint>& descr
			, xmlXPathContext* docctx
			, string basexpath
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppFmncOrgBio1NFabprojectDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlFmncOrgBio1NFabproject::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, const set<uint>& mask
		) : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCORGBIO1NFABPROJECTDATA, jref) {
...
void PnlFmncOrgBio1NFabproject::DpchEngData::merge(
			DpchEngFmnc* dpcheng
		) {
...
void PnlFmncOrgBio1NFabproject::DpchEngData::writeXML(
			const uint ixFmncVLocale
			, pthread_mutex_t* mScr
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngFmncOrgBio1NFabprojectData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		...
		if (has(STATAPPQRY)) QryFmncOrgBio1NFabproject::StatApp::writeXML(wr);
