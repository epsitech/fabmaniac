/**
  ...
  * job handler for job PnlFmncOrgHk1NAddress (declarations)
...
/**
  ...
  */
class PnlFmncOrgHk1NAddress : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQOrgHk1NAddress* rst = NULL, QryFmncOrgHk1NAddress::StatShr* statshrqry = NULL, QryFmncOrgHk1NAddress::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncOrgHk1NAddress(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncOrgHk1NAddress();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncOrgHk1NAddress::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
