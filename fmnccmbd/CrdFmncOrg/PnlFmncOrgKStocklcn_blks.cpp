/**
  * \file PnlFmncOrgKStocklcn_blks.cpp
  * job handler for job PnlFmncOrgKStocklcn (implementation of blocks)
...
void PnlFmncOrgKStocklcn::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContInfFmncOrgKStocklcn";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfFmncOrgKStocklcn";
...
void PnlFmncOrgKStocklcn::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixFmncVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppFmncOrgKStocklcn";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppFmncOrgKStocklcn";
...
void PnlFmncOrgKStocklcn::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrFmncOrgKStocklcn";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrFmncOrgKStocklcn";
...
void PnlFmncOrgKStocklcn::Tag::writeXML(
			const uint ixFmncVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "TagFmncOrgKStocklcn";

	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemFmncOrgKStocklcn";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixFmncVLocale == VecFmncVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Endroit");
...
PnlFmncOrgKStocklcn::DpchAppData::DpchAppData() : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGKSTOCKLCNDATA) {
};
...
void PnlFmncOrgKStocklcn::DpchAppData::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppFmncOrgKStocklcnData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlFmncOrgKStocklcn::DpchAppDo::DpchAppDo() : DpchAppFmnc(VecFmncVDpch::DPCHAPPFMNCORGKSTOCKLCNDO) {
	ixVDo = 0;
};
...
void PnlFmncOrgKStocklcn::DpchAppDo::readXML(
			pthread_mutex_t* mScr
			, map<string,ubigint>& descr
			, xmlXPathContext* docctx
			, string basexpath
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppFmncOrgKStocklcnDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlFmncOrgKStocklcn::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryFmncOrgKStocklcn::StatShr* statshrqry
			, QryFmncOrgKStocklcn::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchEngFmnc(VecFmncVDpch::DPCHENGFMNCORGKSTOCKLCNDATA, jref) {
...
void PnlFmncOrgKStocklcn::DpchEngData::merge(
			DpchEngFmnc* dpcheng
		) {
...
void PnlFmncOrgKStocklcn::DpchEngData::writeXML(
			const uint ixFmncVLocale
			, pthread_mutex_t* mScr
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngFmncOrgKStocklcnData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/fmnc");
		...
		if (has(STATAPPQRY)) QryFmncOrgKStocklcn::StatApp::writeXML(wr);
