/**
  * \file PnlFmncOrgADetail.h
  * job handler for job PnlFmncOrgADetail (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCORGADETAIL_H
#define PNLFMNCORGADETAIL_H
...
/**
  * PnlFmncOrgADetail
  */
class PnlFmncOrgADetail : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncOrgADetailDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncOrgADetail)
	  */
	...
	/**
		* StatApp (full: StatAppFmncOrgADetail)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncOrgADetail)
		*/
	...
	/**
		* StgIac (full: StgIacFmncOrgADetail)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncOrgADetailData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppFmncOrgADetailDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncOrgADetailData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQOrgADetail* rst = NULL, QryFmncOrgADetail::StatShr* statshrqry = NULL, QryFmncOrgADetail::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncOrgADetail::StatShr statshrqry;
		QryFmncOrgADetail::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncOrgADetail(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncOrgADetail();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncOrgADetail::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
