/**
  ...
  * job handler for job PnlFmncOrgSvcMNTool (declarations)
...
/**
  * PnlFmncOrgSvcMNTool
  */
class PnlFmncOrgSvcMNTool : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQOrgSvcMNTool* rst = NULL, QryFmncOrgSvcMNTool::StatShr* statshrqry = NULL, QryFmncOrgSvcMNTool::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncOrgSvcMNTool(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncOrgSvcMNTool();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncOrgSvcMNTool::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
