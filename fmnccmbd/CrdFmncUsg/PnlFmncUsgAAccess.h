/**
  ...
  * job handler for job PnlFmncUsgAAccess (declarations)
...
/**
  * PnlFmncUsgAAccess
  */
class PnlFmncUsgAAccess : public JobFmnc {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQUsgAAccess* rst = NULL, QryFmncUsgAAccess::StatShr* statshrqry = NULL, QryFmncUsgAAccess::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlFmncUsgAAccess(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsgAAccess();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncUsgAAccess::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
