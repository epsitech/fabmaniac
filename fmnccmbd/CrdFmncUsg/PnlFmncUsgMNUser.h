/**
  * \file PnlFmncUsgMNUser.h
  * job handler for job PnlFmncUsgMNUser (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCUSGMNUSER_H
#define PNLFMNCUSGMNUSER_H
...
/**
  * PnlFmncUsgMNUser
  */
class PnlFmncUsgMNUser : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncUsgMNUserDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfFmncUsgMNUser)
	  */
	...
	/**
		* StatApp (full: StatAppFmncUsgMNUser)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrFmncUsgMNUser)
		*/
	...
	/**
		* StgIac (full: StgIacFmncUsgMNUser)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncUsgMNUserData)
		*/
	...
	public:
		StgIac stgiac;
		QryFmncUsgMNUser::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncUsgMNUserDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncUsgMNUserData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQUsgMNUser* rst = NULL, QryFmncUsgMNUser::StatShr* statshrqry = NULL, QryFmncUsgMNUser::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncUsgMNUser::StatShr statshrqry;
		QryFmncUsgMNUser::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncUsgMNUser(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsgMNUser();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncUsgMNUser::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
