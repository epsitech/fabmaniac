/**
  * \file PnlFmncUsgList.h
  * job handler for job PnlFmncUsgList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef PNLFMNCUSGLIST_H
#define PNLFMNCUSGLIST_H
...
/**
  * PnlFmncUsgList
  */
class PnlFmncUsgList : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncUsgListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacFmncUsgList)
	  */
	...
	/**
	  * ContInf (full: ContInfFmncUsgList)
	  */
	...
	/**
		* StatShr (full: StatShrFmncUsgList)
		*/
	...
	/**
		* DpchAppData (full: DpchAppFmncUsgListData)
		*/
	...
	public:
		ContIac contiac;
		StgIac stgiac;
		QryFmncUsgList::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppFmncUsgListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncUsgListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListFmncQUsgList* rst = NULL, QryFmncUsgList::StatShr* statshrqry = NULL, QryFmncUsgList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryFmncUsgList::StatShr statshrqry;
		QryFmncUsgList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlFmncUsgList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsgList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsFmnc* dbsfmnc, QryFmncUsgList::StgIac* _stgiacqry, DpchEngFmnc** dpcheng);
