/**
  * \file QryFmncUsgList.h
  * job handler for job QryFmncUsgList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 7 Mar 2016
  * \date modified: 7 Mar 2016
  */

#ifndef QRYFMNCUSGLIST_H
#define QRYFMNCUSGLIST_H
...
/**
  * QryFmncUsgList
  */
class QryFmncUsgList : public JobFmnc {

public:
	/**
		* VecVOrd (full: VecVQryFmncUsgListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryFmncUsgList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryFmncUsgList)
		*/
	...
	/**
		* StgIac (full: StgIacQryFmncUsgList)
		*/
...
// IP constructor --- BEGIN
	QryFmncUsgList(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~QryFmncUsgList();
...
// IP handleCall --- END
	...
	bool handleCallFmncUsgMod(DbsFmnc* dbsfmnc, const ubigint jrefTrig);
