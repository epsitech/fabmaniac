/**
  * \file CrdFmncUsg.h
  * job handler for job CrdFmncUsg (declarations)
...
/**
  * CrdFmncUsg
  */
class CrdFmncUsg : public JobFmnc {

public:
	/**
		* VecVDo (full: VecVFmncUsgDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppFmncUsgDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngFmncUsgData)
		*/
...
public:
	CrdFmncUsg(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale, const ubigint ref = 0);
	~CrdFmncUsg();
...
public:
	...
	PnlFmncUsgRec* pnlrec;
	PnlFmncUsgHeadbar* pnlheadbar;
	PnlFmncUsgList* pnllist;
