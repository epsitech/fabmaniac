/**
  ...
  * job handler for job PnlFmncUsgRec (declarations)
...
/**
  * PnlFmncUsgRec
  */
class PnlFmncUsgRec : public JobFmnc {
...
public:
	...
	public:
		StatShr(const uint ixFmncVExpstate = VecFmncVExpstate::REGD, const ubigint jrefDetail = 0, const ubigint jrefAAccess = 0, const ubigint jrefMNUser = 0, const bool ButRegularizeActive = true);
...
// IP constructor --- BEGIN
	PnlFmncUsgRec(XchgFmnc* xchg, DbsFmnc* dbsfmnc, const ubigint jrefSup, const uint ixFmncVLocale);
// IP constructor --- END
	~PnlFmncUsgRec();
...
public:
	...
	PnlFmncUsgDetail* pnldetail;
	PnlFmncUsgAAccess* pnlaaccess;
	PnlFmncUsgMNUser* pnlmnuser;
